...
/*			
			// Import activities if not done before and put them on the users session
			if (!phpgwapi_cache::session_get('activitycalendar', 'activities')) {
				phpgwapi_cache::session_set('activitycalendar', 'activities', $this->import_activities());
                $this->log_messages(2);
				return '2';
				$this->clean_up();
			}
...
*/
			...
			phpgwapi_cache::session_clear('activitycalendar', 'activities');
