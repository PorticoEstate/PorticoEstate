...
/*	YAHOO.util.Event.addListener(
		...
		function(e)
		{
     	...
     	window.location = 'index.php?menuaction=activitycalendar.uiorganizationlist.index';
 		}
 	);
*/
	...
	setDataSource(
		'index.php?menuaction=activitycalendar.uiorganizationlist.query&amp;phpgw_return_as=json<?php echo $url_add_on; ?>&amp;editable=<?php echo $editable ? "true" : "false"; ?>',
		columnDefs,
    ...
    function party_export(ptype) {
        var select = document.getElementById('<?php echo $list_id ?>_ctrl_toggle_organization_type');
        var pType = select.options[select.selectedIndex].value;

        var sSelect = document.getElementById('<?php echo $list_id ?>_ctrl_toggle_organization_fields');
        ...
        window.location = 'index.php?menuaction=activitycalendar.uiorganizationlist.download'+
...
<form id="<?php echo $list_id ?>_form" method="GET">
	<fieldset>
		...
		<label class="toolbar_element_label" for="ctrl_toggle_organizationlist_fields"><?php echo lang('search_where') ?>&amp;nbsp;
			<select name="search_option" id="<?php echo $list_id ?>_ctrl_toggle_organizationlist_fields">
	...
	<fieldset>
		<!-- Filters -->
		<label class="toolbar_element_label" for="ctrl_toggle_organizationlist_type"><?php echo lang('part_of_contract') ?></label>
