  ...
  \**************************************************************************/
	...
	class addressbook_uicatalog_contact_addr_type extends phpgwapi_uicommon
	{
		...
		function view()
		{
			...
			self::add_javascript('addressbook', 'portico', 'catalog_addr_type.js');
		...
		{
			$values['id'] = phpgw::get_var('addr_type_id');
			$values['description'] = array('addr_description' => phpgw::get_var('addr_description'));
		...
		function delete()
		{
			$ids = phpgw::get_var('addr_type_id');
