                    ...
                    <div id="addr_type">
                        <fieldset>
                            <div class="pure-control-group">
                                ...
                                <input type="text" name="addr_description" id="addr_description" size="30" value="" />
                                <input type="hidden" name="addr_type_id" id="addr_type_id" size="30" value="" />
                            </div>  
                            <div class="pure-control-group">
                                <label> </label>
                                ...
                                <input type="button" class="pure-button" name="add" id="add" value="{$add}" onClick="addAddrType()" />
