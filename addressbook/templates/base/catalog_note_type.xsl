                    ...
                    <div id="notes_type">
                        <fieldset>
                            <div class="pure-control-group">
                                ...
                                <input type="text" name="note_description" id="note_description" size="30" value="" />
                                <input type="hidden" name="note_type_id" id="note_type_id" size="30" value="" />
                            </div>  
                            <div class="pure-control-group">
                                <label> </label>
                                ...
                                <input type="button" class="pure-button" name="add" id="add" value="{$add}" onClick="addNoteType()" />
