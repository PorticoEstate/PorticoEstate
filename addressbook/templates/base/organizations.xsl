        ...
        <div>
            ...
            <form id="form" name="form" method="post" action="{$form_action}" onsubmit="return process_list()" class="pure-form pure-form-aligned">
                    <div id="tab-content">
                            ...
                            <input id="contact_id" name="contact_id" value="{organizations_data/contact_id}" type="hidden"></input>
                            <input id="owner" name="owner" value="{organizations_data/owner}" type="hidden"></input>
                            ...
                            <div id="org_data">
                                <fieldset>
                                    <div class="pure-control-group">
                                        ...
                                        <input type="text" id="org_name" name="org_name" value="{organizations_data/org_name}">
                                    ...
                                    <div class="pure-control-group">
                                            ...
                                            <input type="checkbox" name="access" id="access" value="1">
                                                    <xsl:if test="organizations_data/access = 'private'">
                                ...
                                <fieldset>
                                    <div class="pure-g">
                                        ...
                                        <div class="pure-u-1 pure-u-md-1-6">
                                            <label for="last-name"> </label>
                                            <div class="pure-input-1">
                                                <button type="button" class="button-xsmall pure-button selector-add-categories"> &gt;&gt; </button><br/>
				...
				<xsl:when test="mode = 'edit'">
                                    <xsl:if test="organizations_data/contact_id > 0">
                                        <div id="others">
                                            <fieldset>
                                                <div class="pure-control-group">
                                                    <label>
                            ...
                            <div id="org_data">
                                <fieldset>
                                    <div class="pure-control-group">
                                        ...
                                        <xsl:value-of select="organizations_data/org_name"/>
                                    </div>                                    
                                    <div class="pure-control-group">
                                        <label>
                                                <xsl:value-of select="php:function('lang', 'Active')"/>
                                        </label>
                                        <xsl:value-of select="organizations_data/org_active"/>
                                    </div>                                    
                                    <xsl:for-each select="comm_data">
                                        <xsl:if test="preferred = 'Y'">
                                            <div class="pure-control-group">
                                    ...
                                    <div class="pure-control-group">          
                                        ...
                                        <div class="pure-custom">
                                            <xsl:for-each select="current_persons/options">
                                                <div>                                 
                                    ...
                                    <div class="pure-control-group">
                                        ...
                                        <xsl:value-of select="organizations_data/owner_name"/>
                                    </div>                     
                                    <div class="pure-control-group">
                                        <label>
                                                <xsl:value-of select="php:function('lang', 'Access')"/>
                                        </label>
                                        <xsl:value-of select="organizations_data/access"/>
                                    </div>
                                    <div class="pure-control-group">          
                                        <label>
