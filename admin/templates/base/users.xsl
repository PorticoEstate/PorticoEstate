	...
	<div class="btngrp">
		<xsl:choose>
			<xsl:when test="add_access = 1">
				<a href="{url_add}" class="pure-button pure-button-primary">
					<xsl:value-of select="lang_add" />
				</a>
			</xsl:when>
		</xsl:choose>
		<a href="{url_done}" class="pure-button pure-button-primary">
	...
	<div id="admin_account_edit">
		...
		<form method="post" action="{edit_url}" class="pure-form pure-form-aligned">
			<div id="account_edit_tabview">
				...
				<div id="user">
					...
					<fieldset id="admin_account_form">
						<div class="pure-control-group">
							<label for="account_active">
								<xsl:value-of select="lang_account_active" class="check" />
							</label>
						...
						<div class="pure-control-group">
							<label for="account_password">
								<xsl:value-of select="lang_password"/>
							</label>
							<input type="password" id="account_password" name="values[passwd]" value="{account_passwd}"/>
						</div>

						<div class="pure-control-group">
							<label for="account_password2">
								<xsl:value-of select="lang_reenter_password"/>
							</label>
						...
						<div class="pure-control-group">
							...
							<span class="value">
								<a href="{url_contacts}">
									<xsl:value-of select="url_contacts_text" />
								</a>
							</span>
						</div>
						...
						<div class="pure-control-group">
							<label for="changepassword">
								<xsl:value-of select="lang_changepassword" class="check" />
							</label>
						...
						<div class="pure-control-group">
							<label for="anonymous">
								<xsl:value-of select="lang_anonymous" class="check" />
							</label>
						...
						<div class="pure-control-group">
							<label for="account_expires">
								<xsl:value-of select="lang_expires"/>
							</label>
							...
							<label for="expires_never">
								<xsl:value-of select="lang_never" class="check" />
							</label>
						...
						<div class="pure-control-group">
							<label for="account_quota">
								<xsl:value-of select="lang_quota"/>
							</label>
				...
				<div id="apps">
					<h2>
						<xsl:value-of select="lang_applications" />
					</h2>
					<table  class="pure-table">
						<thead>
							<tr>
