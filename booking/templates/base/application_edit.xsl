<xsl:template match="data" xmlns:php="http://php.net/xsl">
	...
	<script type="text/javascript">
		...
		var lang = <xsl:value-of select="php:function('js_lang', 'From', 'To', 'Resource Type', 'Name', 'Accepted', 'Document', 'You must accept to follow all terms and conditions of lease first.', 'article', 'Select', 'price', 'unit', 'quantity')"/>;
