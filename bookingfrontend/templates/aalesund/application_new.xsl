	...
	<div class="container new-application-page pt-5" id="new-application-page">
            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2">                   
					...
					<h2 class="font-weight-bold mb-4"><xsl:value-of select="php:function('lang', 'Building (2018)')" /></h2>
                    ...
                    <div class="form-group">
						<label><xsl:value-of select="php:function('lang', 'Resource (2018)')" />*</label>
                    ...
                    <div class="form-group">
						<label><xsl:value-of select="php:function('lang', 'Date and time')" />*</label>
                        <div class="form-group">
                        <div class="row">
                    ...
                    <h2 class="font-weight-bold mb-4"><xsl:value-of select="php:function('lang', 'Information about the event')" /></h2>
					...
					<div class="form-group">
						<label><xsl:value-of select="php:function('lang', 'Event name')" />*</label>
						<input type="text" class="form-control" name="name" value="{application/name}"/>
					</div>

					<div class="form-group">
						<label><xsl:value-of select="php:function('lang', 'Organizer')" />*</label>
						<input type="text" class="form-control" name="organizer" value="{application/organizer}"/>
					</div>

					<div class="form-group">
						<label><xsl:value-of select="php:function('lang', 'Homepage for the event')" /></label>
					...
					<div class="form-group">
						<label><xsl:value-of select="config/application_equipment"/></label>
                    ...
                    <div class="form-group termAccept mt-5 mb-5">
						<label><xsl:value-of select="php:function('lang', 'legal condition')" />*</label>
