...
<!--            <div class="text-center  mt-4 mb-5"    >-->
          ...
          <div   id="ssd" >  
<!--	<p class="ex1"><xsl:value-of disable-output-escaping="yes" select="frontpagetext"/></p>-->
<!--                  <xsl:value-of disable-output-escaping="yes" select="frontpagetext"/>                      -->
           </div>
           
<!--            <ul>
               <li    style=" list-style-type:none;width:600px; margin-left: 9.5em;"    > 
                   <p> <xsl:value-of disable-output-escaping="yes" select="frontpagetext"/> 
                   </p>
               </li>
           </ul>     -->
