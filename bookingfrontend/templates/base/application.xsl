        ...
        <div class="container wrapper">
			...
			<div class="row">
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>1. <xsl:value-of select="php:function('lang', 'History and comments (%1)', count(application/comments/author))" /></dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>2. <xsl:value-of select="php:function('lang', 'Why?')" /></dt>
						<dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>3. <xsl:value-of select="php:function('lang', 'Where?')" /></dt>
						<dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>4. <xsl:value-of select="php:function('lang', 'When?')" /></dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>5. <xsl:value-of select="php:function('lang', 'Who?')" /></dt>
						<dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>6. <xsl:value-of select="php:function('lang', 'Contact information')" /></dt>
						<dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>7. <xsl:value-of select="php:function('lang', 'responsible applicant')" /> / <xsl:value-of select="php:function('lang', 'invoice information')" /></dt>
				...
				<div class="col-12 mt-4">
					<dl>
						<dt>8. <xsl:value-of select="php:function('lang', 'Terms and conditions')" /></dt>
