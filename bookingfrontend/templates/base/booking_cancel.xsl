	...
	<div id="booking-cancel-page-content" class="margin-top-content">
        	<div class="container wrapper">
				<div class="location">
					...
					<span><xsl:value-of select="php:function('lang', 'Cancel bookings')"/></span>										
				</div>
            	...
            	<div class="row">
					...
					<form action="" method="POST" class="col-md-8">
						...
						<div class="form-group">
							<label class="text-uppercase"><xsl:value-of select="php:function('lang', 'Cancel allocation also')" /></label>
							<div>
						...
						<div class="form-group">
							<label class="text-uppercase"><xsl:value-of select="php:function('lang', 'Recurring allocation cancelation')" /></label>
							<div>
