       	...
       	<div class="row">
			<form action="" method="POST" class="col-md-8">
				...
				<div class="form-group">
					<label class="text-uppercase"><xsl:value-of select="php:function('lang', 'Bookings to be deleted')" /></label>
				...
				<xsl:if test="delete_allocation='on'">
					<div class="form-group">
						<label class="text-uppercase"><xsl:value-of select="php:function('lang', 'Allocations that is going to be deleted')" /></label>
					...
					<div class="form-group">
						<label class="text-uppercase"><xsl:value-of select="php:function('lang', 'Allocations with still existing bookings (%1)', count(allocation_keep[from_]))" /></label>
