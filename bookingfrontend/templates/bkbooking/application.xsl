...
<xsl:template match="data" xmlns:php="http://php.net/xsl">
	...
	<script>
        ...
        <![CDATA[
            ...
            var applicationURL = phpGWLink('bookingfrontend/index.php', {menuaction:'bookingfrontend.uiapplication.associated', filter_application_id:app_id, length:-1}, true);
		...
		createTable('associated_container', applicationURL, colDefsApplication, '', 'pure-table pure-table-bordered');
		}

		var colDefsDocument = [{key: 'name', label: lang['Document'], formatter: genericLink}];
		createTable('regulation_documents', documentURL, colDefsDocument, '', 'pure-table pure-table-bordered');
