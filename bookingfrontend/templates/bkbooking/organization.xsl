<xsl:template match="data" xmlns:php="http://php.net/xsl">
	...
	<script>
		...
		var documentURL = phpGWLink('bookingfrontend/index.php', {menuaction:'bookingfrontend.uidocument_organization.index', sort:'name', no_images:1, filter_owner_id:organization_id, length:-1}, true);
