								...
								<div class="row">
									<div class="col-12 mb-4 d-flex flex-column align-items-center">
										<label class="input-icon w-100" aria-labelledby="input-text-icon">
											...
											<input type="text" onkeydown="return false" class="js-basic-datepicker bookingDate"
...
<!--							</label>-->
					...
					<div class="col-12 mb-4">
						...
						<input required="true" id="inputEventName" type="text" class="w-100" name="name" value="{application/name}">
							<xsl:attribute name="placeholder">
					...
					<div class="col-12 mb-4">
						...
						<input required="true" id="inputOrganizerName" type="text" class="w-100" name="organizer" value="{application/organizer}" placeholder="Navn på arrangør">
							<xsl:attribute name="placeholder">
								<xsl:value-of select="php:function('lang', 'organizer/responsible seeker')"/>
							</xsl:attribute>
						</input>
					...
					<div class="col-12 mb-4">
						...
						<input placeholder="Hjemmeside for aktiviteten/arrangementet" type="text" class="w-100" name="homepage" value="{application/homepage}">
							<xsl:attribute name="placeholder">
								<xsl:value-of select="php:function('lang', 'Event/activity homepage')"/>
							</xsl:attribute>
						</input>
					...
					<div class="col-12 mb-4">
						...
						<textarea id="field_description" style="resize: none;" class="w-100" rows="3" name="description" value="{application/description}">
							<xsl:attribute name="placeholder">
