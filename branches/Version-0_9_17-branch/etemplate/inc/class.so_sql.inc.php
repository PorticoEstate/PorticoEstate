...
* @package etemplate
* @version $Id: class.so_sql.inc.php 17947 2007-02-13 12:59:32Z sigurdne $
*/
...
class so_sql
{
	...
	* @return data array if row could be retrived else False and data = array()
	*/
	function read($keys)
	{
		$this->init($keys);
	...
	/**
	* deletes row representing keys in internal data or the supplied $keys if != ''
	*
