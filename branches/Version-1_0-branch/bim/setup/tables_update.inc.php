<?php
	...
	*/
	...
	function bim_upgrade0_9_17_506()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('fm_bim_item','department_id', array('type' => 'int', 'precision' => 4,'nullable' => true));
	...
	*/
	...
	function bim_upgrade0_9_17_508()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('fm_bim_item','entity_group_id', array('type' => 'int', 'precision' => 4,'nullable' => true));
