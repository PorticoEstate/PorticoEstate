...
*/
		...
		public function add_actions(&$value, $key, $params)
		{
			...
			//view/download
			$value['ajax'][] = false;
			$value['actions'][] = html_entity_decode(self::link(array('menuaction' => 'controller.uidocument.view', 'id' => $value['id'])));
...
/*			}
		...
		public function redirect($document, $document_properties, $error, $message)
		{
			...
			{
				$GLOBALS['phpgw']->redirect_link('/index.php', array('menuaction' => 'controller.uiprocedure.edit', 'id' => $document_properties['id'], 'error' => $error, 'message' => $message));		
			}
		}
