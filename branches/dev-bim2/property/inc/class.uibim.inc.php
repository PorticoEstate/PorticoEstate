...
HTML;
	...
	public function uploadFile($uploadedFileArray = null, $modelName = null, $unitTest = false) {
		...
		$link_to_models	= $GLOBALS['phpgw']->link('/index.php',array('menuaction'=> 'property.uibim.showModels'));
		$link_to_upload	= $GLOBALS['phpgw']->link('/index.php',array('menuaction'=> 'property.uibim.upload'));
		$data = array
		(
				'modelName'						=> $modelName,
				'error'							=> $error,
