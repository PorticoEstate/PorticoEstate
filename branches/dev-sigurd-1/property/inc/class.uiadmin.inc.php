	...
	//		$acl_app			= get_var('acl_app',array('GET'));
		...
		function contact_info()
		{
			...
			foreach ( $group_list as $entry )
			{
				...
				(
					'id'	=> $entry['account_id'],
					'name'	=> $entry['account_lid'],
					'selected' => $entry['account_id'] == $prefs['groupdefault']
				);
			}
			...
			foreach ( $account_list as $entry )
			{
				if($entry['account_status'] == 'A')
				{
					...
					(
						'id'	=> $entry['account_id'],
						'name'	=> $entry['account_firstname'] . ' ' . $entry['account_lastname'],
						'selected' => $entry['account_id'] == $prefs['assigntodefault']
					);
				}
			}
