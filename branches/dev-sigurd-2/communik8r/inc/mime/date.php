 ...
 *
 * $Id: date.php,v 1.1.1.1 2005/08/23 05:04:03 skwashd Exp $
...
function getDateString( $stamp ) {
    ...
    if (($show_full_date == 1) || ($nextmid < $stamp)) {
        ...
        /* Today */
        $date_format =  $GLOBALS['phpgw_info']['user']['preferences']['common']['timeformat'];
    } else if ($midnight - 518400 < $stamp) {
        /* This week */
        $date_format = "D, {$GLOBALS['phpgw_info']['user']['preferences']['common']['timeformat']}";
    } else {
        /* before this week */
        $date_format =  $GLOBALS['phpgw_info']['user']['preferences']['common']['dateformat'];
    }
