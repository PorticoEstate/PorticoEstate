    			...
    			<ul class="user_menu">
    				...
    				<li>
	    				...
	    				<div style="float: right;">
	    					<a href="home.php"  class="header_link"><em><img src="frontend/templates/base/images/16x16/door_open.png" class="list_image"/></em><xsl:value-of select="php:function('lang', 'home')"/></a>
	    				</div>
    				</li>
    			</ul>
			</div>
