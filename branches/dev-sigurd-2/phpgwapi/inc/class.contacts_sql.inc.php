		...
		*/
		function read_single_entry($id,$fields='')
		{
			...
			(
				...
				'geo'				=> '',
				'tel_work'			=> isset($person_data['work phone']) ? $person_data['work phone'] : '',
				'tel_home'			=> isset($person_data['home phone']) ? $person_data['home phone'] : '',
				'tel_voice'			=> isset($person_data['voice phone']) ? $person_data['voice phone'] : '',
				'tel_msg'			=> isset($person_data['msg phone']) ? $person_data['msg phone'] : '',
				'tel_fax'			=> isset($person_data['work fax']) ? $person_data['work fax'] : '',
				'tel_pager'			=> isset($person_data['pager']) ? $person_data['pager'] : '',
				'tel_cell'			=> isset($person_data['mobile (cell) phone']) ? $person_data['mobile (cell) phone'] : '',
				'tel_bbs'			=> isset($person_data['bbs']) ? $person_data['bbs'] : '',
				'tel_modem'			=> isset($person_data['modem']) ? $person_data['modem'] : '',
				'tel_isdn'			=> isset($person_data['isdn']) ? $person_data['isdn'] : '',
				'tel_car'			=> isset($person_data['car phone']) ? $person_data['car phone'] : '',
				'tel_video'			=> isset($person_data['video']) ? $person_data['video'] : '',
				'tel_prefer'		=> '',
				'email'				=> isset($person_data['work email']) ? $person_data['work email'] : '',
				'email_type'		=> isset($person_data['comm_type']['work email']) ? $person_data['comm_type']['work email'] : '',
				'email_home'		=> isset($person_data['home email']) ? $person_data['home email'] : '',
				...
				'url'				=> isset($person_data['website']) ?  $person_data['website'] : '',
				'pubkey'			=> isset($person_data['per_pubkey']) ? $person_data['per_pubkey'] : '',
