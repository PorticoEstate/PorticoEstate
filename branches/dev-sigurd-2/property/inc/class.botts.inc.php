	...
	*/
	...
	class property_botts
	{
		...
		function property_botts($session=false)
		{
			...
			$this->status_id		= isset($_REQUEST['status_id']) && $status_id ? $status_id : $this->status_id;
			$this->user_id			= isset($_REQUEST['user_id']) && $user_id ? $user_id : '';
			$this->part_of_town_id	= isset($_REQUEST['part_of_town_id']) && $part_of_town_id ? $part_of_town_id : $this->part_of_town_id;
			$this->district_id		= isset($_REQUEST['district_id']) && $district_id ? $district_id : $this->district_id;
			$this->allrows			= isset($allrows) && $allrows ? $allrows : '';
			$this->start_date		= isset($_REQUEST['start_date']) && $start_date ? $start_date : $this->start_date;
			$this->end_date			= isset($_REQUEST['end_date']) && $end_date ? $end_date : $this->end_date;
		}
