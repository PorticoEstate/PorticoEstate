...
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by) VALUES (1075593600,1706832000,".strtotime('2004-02-15').",{$loc_id_out},2,{$rental_out}, 1250593658, {$rental_out})");
	// Vitalitetssenteret
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (1045008000,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000659')");
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (1047945600,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000660')");
	// Gullstøltunet sykehjem
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (915148800,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000585')");
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (915148800,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000586')");
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (915148800,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000587')");
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (1136073600,NULL,".strtotime('2006-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00006497')");
	// Bergen Rådhus
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (1199145600,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000797')");
$oProc->query("INSERT INTO rental_contract (date_start, date_end, billing_start, location_id, term_id, executive_officer, created, created_by, old_contract_id) VALUES (1104537600,NULL,".strtotime('2005-01-01').",{$loc_id_internal},1,{$rental_internal}, 1250593658, {$rental_internal},'K00000798')");
