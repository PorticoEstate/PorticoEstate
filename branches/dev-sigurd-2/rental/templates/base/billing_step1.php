...
print 'Billing run started at '.date('Y-m-d H:i:s')."\n<br/>\n";
$date = date('Y-m-d'); // We make sure we use the same date during the complete run
// First we have to get all active contracts

print 'Billing run finished at '.date('Y-m-d H:i:s').' Time spent: '.(time() - $timestamp_start). " seconds.\n<br/>\n";
?>