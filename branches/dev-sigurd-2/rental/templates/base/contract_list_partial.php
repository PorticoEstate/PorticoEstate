	...
	YAHOO.util.Event.addListener(
		...
		{	
			...
			if(value != 'all'){
				...
				if(value == 'ended'){
					document.getElementById('label_contract_status').innerHTML = '<?php echo lang('rental_contract_status_before') ?>';
				} else {
					document.getElementById('label_contract_status').innerHTML = '<?php echo lang('rental_contract_status_date') ?>';
				}
			} else {
...
<form id="<?php echo $list_id ?>_form" method="GET">
	<fieldset>
		...
		<label for="ctr_toggle_search_type"><?php echo lang('rental_rc_search_where') ?></label>
		<select name="search_option" id="ctr_toggle_seach_type">
			<option value="all" selected="selected"><?php echo lang('rental_rc_all') ?></option>
			<option value="id"><?php echo lang('rental_contract_id') ?></option>
			<option value="party_name"><?php echo lang('rental_contract_partner_name') ?></option>
			<option value="composite"><?php echo lang('rental_contract_composite_name') ?></option>
		</select>
	...
	<fieldset>
		...
		<h3><?php echo lang('rental_contract_status') ?></h3>
		<select name="contract_status" id="<?php echo $list_id ?>_ctrl_toggle_contract_status" >
			<option value="under_planning"><?php echo lang('rental_contract_under_planning') ?></option>
			<option value="active"><?php echo lang('rental_contract_active') ?></option>
			<option value="under_dismissal"><?php echo lang('rental_contract_under_dismissal') ?></option>
			<option value="ended"><?php echo lang('rental_contract_ended') ?></option>
			<option value="all" selected="selected"><?php echo lang('rental_contract_all') ?></option>
		</select>
		<label class="toolbar_element_label" for="calendarPeriodFrom" id="label_contract_status"><?php echo lang('rental_contract_status_date') ?></label>
		...
		<div id="calendarStatusDate">
			...
			<div class="calheader">
				<button id="calendarStatusDateCloseButton"><?php echo lang('rental_calendar_close') ?></button>
				<button id="calendarStatusDateClearButton"><?php echo lang('rental_calendar_clear') ?></button>
			</div>
		</div>
	</fieldset>
	...
	<fieldset>
		...
		<h3><?php echo lang('rental_common_filters') ?></h3>
			<label class="toolbar_element_label" for="ctrl_toggle_contract_type"><?php echo lang('rental_contract_type') ?></label>
