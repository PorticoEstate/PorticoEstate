...
<h1><img src="<?php echo RENTAL_TEMPLATE_PATH ?>images/32x32/custom/contact.png" /><em> <?php echo lang('party') ?>: <?php echo $party->get_name() ?></em></h1>
...
<form action="#" method="post">
	...
	<div id="party_edit_tabview" class="yui-navset">
		<ul class="yui-nav">
			...
			<li><a href="#comments_party"><em><img src="<?php echo RENTAL_TEMPLATE_PATH ?>images/16x16/apps/internet-group-chat.png" alt="icon" /> <?php echo lang('comments') ?></em></a></li>
		</ul>
