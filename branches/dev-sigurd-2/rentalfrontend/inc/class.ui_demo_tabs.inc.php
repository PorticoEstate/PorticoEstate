<?php
	...
	class rentalfrontend_ui_demo_tabs
	{
		...
		public function __construct()
		{
			...
			$tabs[] = array(
				'label' => lang('tab # %1', 1),
				'link'  => $GLOBALS['phpgw']->link('/index.php',array('menuaction' => 'rentalfrontend.ui_demo_tabs.first', 'type'=>1, 'noframework' => $noframework))
			);
			$tabs[] = array(
				'label' => lang('tab # %1', 2),
				'link'  => $GLOBALS['phpgw']->link('/index.php',array('menuaction' => 'rentalfrontend.ui_demo_tabs.second', 'type'=>'2', 'noframework' => $noframework))
			);
			$tabs[] = array(
				'label' => lang('tab # %1', 3),
				'link'  => $GLOBALS['phpgw']->link('/index.php',array('menuaction' => 'rentalfrontend.ui_demo_tabs.third', 'type'=>'3', 'noframework' => $noframework))
			);
			...
			$GLOBALS['phpgw_info']['flags']['menu_selection'] = 'rentalfrontend::demo_tab';
		}
		...
		public function second()
		{
			...
			(
				'td_count'			=> 2,
				'base_java_url'		=> "{menuaction:'rentalfrontend.ui_demo_tabs.first'}",
			...
			$GLOBALS['phpgw']->js->validate_file( 'yahoo', 'demo_tabs.second', 'rentalfrontend' );
