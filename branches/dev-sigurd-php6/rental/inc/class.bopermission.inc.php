<?php
	...
	abstract class rental_bopermission extends rental_bocommon_authorized
	{
		protected
			$object_bo;
		...
		function __construct()
		{
			...
			$this->so = CreateObject(sprintf('rental.sopermission_%s', $object_type));
			$this->object_bo = CreateObject(sprintf('rental.bo%s', $object_type));
		}
