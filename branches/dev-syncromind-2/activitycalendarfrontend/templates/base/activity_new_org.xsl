<xsl:template match="data" xmlns:php="http://php.net/xsl">
	<div>
		...
		<h1>
			<xsl:value-of select="php:function('lang', 'new_organization')" />
		</h1>
		<div>
		...
		<form action="" method="post" id="form" name="form">
			...
			<dl>
				...
				<dd>
					<input type="text" name="orgname" size="100" />
				</dd>
				<dt>
				...
				<dd>
					<input type="text" name="homepage" size="100" />
				</dd>
				<dt>
				...
				<dd>
					<input type="text" name="postaddress" size="100" />
				</dd>
				<dt>
