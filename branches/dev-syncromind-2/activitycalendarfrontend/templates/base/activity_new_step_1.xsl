<xsl:template match="data" xmlns:php="http://php.net/xsl">
	<div>
		<div class="pageTop">
			<h1>
				<xsl:value-of select="php:function('lang', 'new_activity_helptext')" />
			</h1>
							...
							<dl class="proplist-col">
								...
								<dt>
									<label for="organization_id">
										<xsl:value-of select="php:function('lang', 'choose_org')" />
									</label>
								...
								<a id="displayText3" href="javascript:void(0);">Ikke i listen? Registrer ny organisasjon</a>
								<br />
								<dt>
									<div style="overflow:hidden;" id="toggleText3">
										<dl>
											<div style="overflow:hidden;">
												...
												Felt merket med (*) er påkrevde felt <br />
												<br />
												<dt>
												...
												<dd>
													<input type="text" name="orgname" id="orgname" maxlength="254" class="pure-u-1 input-80" />
												</dd>
												<dt>
												...
												<div class="input-part-1">
													...
													<dd>
														<input id="address" onkeyup="javascript:get_address_search()" name="address" class="pure-u-1 input-50" type="text" />
														<br />
												...
												<div class="input-part-1">
													<dt>
														<label for="postzip">Postnummer</label>
														<br />
													</dt>
													<dd>
											...
											<dd>
												<input name="homepage" value="http://" class="pure-u-1 input-80" type="text" maxlength="254" />
											</dd>
											<br />
											<br />
											<div style="overflow:hidden;">
												...
												<dd>
													<input name="org_contact1_name" id="org_contact1_name" type="text" class="pure-u-1 input-80" maxlength="254" />
												</dd>
												<dt>
												...
												<dd>
													<input name="org_contact1_mail" id="org_contact1_mail" type="text" class="pure-u-1 input-50" />
												</dd>
												<dt>
													<label for="contact2_mail">Gjenta e-post (*)</label>
												</dt>
												<dd>
													<input name="org_contact2_mail" id="org_contact2_mail" type="text" class="pure-u-1 input-50" />
												</dd>
											</div>
										</dl>
									</div>
