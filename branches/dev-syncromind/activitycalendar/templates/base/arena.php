...
<div class="yui-content">
	<div id="details">
		<form action="#" method="post">
			<input type="hidden" name="id" value="<?php if($arena->get_id())
			{ echo $arena->get_id();}
			else
			{ echo '0';}?>"/>
					...
					{?>
						...
						<dd>
							<select name="arena_active" id="arena_active">
								<option value="yes" <?php if($arena->is_active())
				{ echo "selected";}?>><?php echo lang('active')?></option>
								<option value="no" <?php if(!$arena->is_active())
				{ echo "selected";}?>><?php echo lang('inactive')?></option>
							</select>
						</dd>
						<?php
					}
					...
					{
						?>
						<dt><label><?php if($arena->is_active())
				{?><font style="color: green;"><?php echo lang('active_arena');?></font><?php }
				else
				{?><font style="color: red;"><?php echo lang('inactive_arena');?></font><?php }?></label></dt>
						<dd>&nbsp;</dd>
	<?php }?>
			</dl>
