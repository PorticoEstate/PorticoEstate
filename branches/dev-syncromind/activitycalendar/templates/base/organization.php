...
<div class="yui-content">
	<div id="details">
		<form action="#" method="post">
			<input type="hidden" name="id" value="<?php if($organization->get_id())
{ echo $organization->get_id();}
else
{ echo '0';}?>"/>
			<input type="hidden" name="original_org_id" value="<?php if($organization->get_original_org_id())
			...
			<dl class="proplist-col">
				...
				<dd>
						<?php if($editable)
							{?>
								<?php
								$curr_district = $organization->get_district();
