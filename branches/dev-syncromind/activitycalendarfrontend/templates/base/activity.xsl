					...
					<dt>
						<xsl:if test="activity/contact_person_1 = 1">
							<label for="contact_person_1">
								<xsl:value-of select="php:function('lang', 'contact_person')" />
							</label>
						</xsl:if>
					</dt>
					<dd>
						<label for="contact1_name">Navn </label>
						<xsl:value-of select="concat(' ', activity/contact1_name)" />
						<br />
						<label for="contact1_phone">Telefon </label>
						<xsl:value-of select="concat(' ', activity/contact1_phone)" />
						<br />
						<label for="contact1_mail">E-post </label>
						<xsl:value-of select="concat(' ', activity/contact1_mail)" />
						<br />
					</dd>
				</fieldset>
				<fieldset>
