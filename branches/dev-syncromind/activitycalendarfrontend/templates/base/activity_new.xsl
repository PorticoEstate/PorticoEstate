<xsl:template match="data" xmlns:php="http://php.net/xsl">
	<div>
		...
		<div class="pageTop">
			<h1>
				<xsl:value-of select="php:function('lang', 'new_activity')" />
			</h1>
			<div>
								...
								<div style="overflow:auto;" id="toggleText">
									<dl>
										...
										<div class="input-part-1">
											...
											<dd>
												<input id="arena_address" onkeyup="javascript:get_address_search_arena()" name="arena_address" class="pure-u-1 input-50" type="text" />
												<br />
										...
										<div class="input-part-2">
											<dt>
												<label for="arena_number">Husnummer</label>
												<br />
											</dt>
											<dd>
										...
										<div class="input-part-1">
											<dt>
												<label for="postaddress">Postnummer (*)</label>
												<br />
											</dt>
											<dd>
										...
										<div class="input-part-2">
											<dt>
												<label for="arena_postaddress">Poststed (*)</label>
												<br />
											</dt>
											<dd>
