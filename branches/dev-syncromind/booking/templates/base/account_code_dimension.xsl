    ...
    <form action="" method="POST" id='form' class="pure-form pure-form-aligned" name="form">
        ...
        <div id="tab-content">
            ...
            <div id="account_code" class="booking-container">
                ...
                <div class="pure-control-group">
                    <div class="heading">
                        <legend><h3><xsl:value-of select="php:function('lang', 'External account')"/></h3></legend>
                    </div>
                </div>
                <div class="pure-control-group">
                    <p><h4><xsl:value-of select="php:function('lang', 'External_account_helptext')"/></h4></p>
                </div>
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'External customer output format')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'External file linebreak ')"/></label>
                ...
                <div class="pure-control-group">
                    <p><h4><xsl:value-of select="php:function('lang', 'Internal_account_helptext')"/></h4></p>
                </div>
                <div class="pure-control-group">
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Internal customer output format')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'File output')"/></label>
                ...
                <div class="pure-control-group">
                    <p><h4><xsl:value-of select="php:function('lang', 'export_help_text')"/></h4></p>
                </div>
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Export method')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Export path')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Ftp host')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Ftp basedir')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Ftp user')"/></label>
                ...
                <div class="pure-control-group">
                    <label><xsl:value-of select="php:function('lang', 'Ftp password')"/></label>
                ...
                <div class="pure-control-group">
                    <label>
                        ...
                        <span style="display:block;font-size:10px;font-weight:normal;margin-top:-8px;"><xsl:value-of select="php:function('lang', 'Do not edit!')"/></span>
                    </label>
