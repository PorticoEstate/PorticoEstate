        ...
        <xsl:value-of disable-output-escaping="yes" select="allocation/tabs"/>
            <div id="allocation_new">
                ...
                <div class="pure-control-group">
                    <label for="field_building_name"><h4><xsl:value-of select="php:function('lang', 'Building')" /></h4></label>
                ...
                <div class="pure-control-group">
                    <label for="field_org_name"><h4><xsl:value-of select="php:function('lang', 'Organization')" /></h4></label>
                    <!--div class="autocomplete"-->
                ...
                <div class="pure-control-group">
                    <label for="field_weekday"><h4><xsl:value-of select="php:function('lang', 'Weekday')" /></h4></label>
                ...
                <div class="pure-control-group">
                    <label for="field_from"><h4><xsl:value-of select="php:function('lang', 'From')" /></h4></label>
                ...
                <div class="pure-control-group">
                    <label for="field_to"><h4><xsl:value-of select="php:function('lang', 'To')" /></h4></label>
                    <!--div class="time-picker"-->
                ...
                <div class="pure-control-group">
                    <label for="outseason"><h4><xsl:value-of select="php:function('lang', 'Recurring allocation')" /></h4></label>
