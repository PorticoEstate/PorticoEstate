            ...
            <fieldset>
                <div class="pure-g">
                    <div class="pure-u-1">
                        ...
                        <xsl:if test="not(frontend)">
                            ...
                            <div class="pure-control-group">
                                <label><xsl:value-of select="php:function('lang', 'Modified')" /></label>
                        ...
                        <form method="POST">
                            <div class="pure-control-group">
                                <label for="comment"><xsl:value-of select="php:function('lang', 'Add a comment')" /></label>
                ...
                <div class="pure-g">
                    ...
                    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
                        ...
                        <div class="pure-control-group">
                            <label style="vertical-align: top;width: auto;"><xsl:value-of select="php:function('lang', 'Number of participants')" /></label>
                    ...
                    <div class="pure-u-1  pure-u-md-1-2 pure-u-lg-1-3">
                        ...
                        <div class="pure-control-group">
                            <xsl:if test="application/customer_identifier_type = 'ssn'">
                                <label><xsl:value-of select="php:function('lang', 'Date of birth or SSN')" /></label>
