<xsl:template match="data" xmlns:php="http://php.net/xsl">
        ...
        <div id="tab-content">
            ...
            <div id="application_add" class="booking-container">
                <xsl:if test="config/application_new_application">
                    <p style="width: 750px;"><xsl:value-of select="config/application_new_application"/></p>
                </xsl:if>
                <div class="pure-g">
                    ...
                    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
                        <fieldset>
                            ...
                            <xsl:if test="config/application_where">
                                <p><xsl:value-of select="config/application_where"/></p>
                            </xsl:if>
                            <div class="pure-control-group">
                                <label for="field_building_id"><xsl:value-of select="php:function('lang', 'Building')" /></label>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="position() > 1">
                                            <div class="date-container">
                                                ...
                                                <div class="pure-control-group">
                                                    <label for="end_date_{$index}"><xsl:value-of select="php:function('lang', 'To')" /></label>
                        ...
                        <fieldset>
                            <div class="pure-control-group">
                                ...
                                <xsl:if test="config/application_responsible_applicant">
                                    <p><xsl:value-of select="config/application_responsible_applicant"/></p>
                                </xsl:if>
                                <!--xsl:copy-of select="phpgw:booking_customer_identifier(application, '')"/-->
                                <br />
                                <xsl:if test="config/application_invoice_information">
                                    <p><xsl:value-of select="config/application_invoice_information"/></p>
                                </xsl:if>
                            </div>
                        </fieldset>
                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="pure-control-group">
                                ...
                                <xsl:if test="config/application_terms2">
                                    <p><xsl:value-of select="config/application_terms2"/></p>
                                </xsl:if>
    ...
    <script type="text/javascript">
        ...
        $('#field_customer_identifier_type').attr("data-validation-error-msg","<xsl:value-of select="php:function('lang', 'Customer identifier type is required')"/>");
    </script>
</xsl:template>
