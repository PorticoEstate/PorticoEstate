        ...
        <div id="tab-content">
            ...
            <div id="settings" class="booking-container">
                <div class="pure-control-group">
                    <label for="field_application_new_application"><xsl:value-of select="php:function('lang', 'New application')"/></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_activities"><xsl:value-of select="php:function('lang', 'Activity')"/></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_howmany"><xsl:value-of select="php:function('lang', 'How many?')" /></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_where"><xsl:value-of select="php:function('lang', 'Where?')" /></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_when"><xsl:value-of select="php:function('lang', 'When?')" /></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_who"><xsl:value-of select="php:function('lang', 'Who?')" /></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_contact_information"><xsl:value-of select="php:function('lang', 'Contact information')" /></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_responsible_applicant"><xsl:value-of select="php:function('lang', 'responsible applicant')" /> / <xsl:value-of select="php:function('lang', 'invoice information')" /><span> 1</span></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_invoice_information"><xsl:value-of select="php:function('lang', 'responsible applicant')" /> / <xsl:value-of select="php:function('lang', 'invoice information')" /><span> 2</span></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_terms"><xsl:value-of select="php:function('lang', 'Terms and conditions')" /><span> 1</span></label>
                ...
                <div class="pure-control-group">
                    <label for="field_application_terms2"><xsl:value-of select="php:function('lang', 'Terms and conditions')" /><span> 2</span></label>
