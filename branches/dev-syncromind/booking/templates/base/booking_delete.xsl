            ...
            <div id="tab-content">
                ...
                <div id="booking_delete">
                    ...
                    <div class="pure-control-group">
                        <h4><xsl:value-of select="php:function('lang', 'Booking Delete Information')"/></h4>
                        <h4><xsl:value-of select="php:function('lang', 'Booking Delete Information2')"/></h4>
                        <h4><xsl:value-of select="php:function('lang', 'Booking Delete Information3')"/></h4>
                    </div>
                    <div class="pure-control-group">
