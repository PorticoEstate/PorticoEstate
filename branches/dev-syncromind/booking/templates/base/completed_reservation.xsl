    ...
    <div id='form' class="pure-form pure-form-aligned" name="form">
        ...
        <div id="tab-content">
            ...
            <div id="completed_reservation" class="booking-container">
                <field>
                    <h1><xsl:value-of select="php:function('lang', string(reservation/reservation_type))"/> #<xsl:value-of select="reservation/id"/></h1>
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Cost')" /></label>
                        <span><xsl:value-of select="reservation/cost"/></span>
                    </div>
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Customer Type')" /></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Exported')" /></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Export File')" /></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Order id')" /></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Article Description')" /></label>
