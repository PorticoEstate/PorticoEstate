    ...
    <form action="" method="POST" id='form' class="pure-form pure-form-stacked" name="form">
        ...
        <div id="tab-content">
            ...
            <div id="completed_reservation_edit" class="booking-container">
                <fieldset>
                    <div class="heading">
                        <legend><h3><xsl:value-of select="php:function('lang', 'Edit completed reservation')"/></h3></legend>
                    </div>
                    <div class="pure-g">
                    ...
                    <div class="pure-g">
                        <div class="pure-u-1 pure-u-sm-1-2 pure-u-md-1-3 pure-u-lg-1-4">
                            <div class="pure-control-group">
                                <label for="field_article_description"><xsl:value-of select="php:function('lang', 'Article Description')" /></label>
