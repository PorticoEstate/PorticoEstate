<xsl:template name="contactpersonfields" xmlns:php="http://php.net/xsl">
    <dl class="form">
        ...
        <dt><label for="contact-field-ssn"><xsl:value-of select="php:function('lang', 'Social Security Number')" /></label></dt>
        <dd>
        ...
        <dt><label for="contact-field-homepage"><xsl:value-of select="php:function('lang', 'Homepage')" /></label></dt>
        <dd>
        ...
        <dt><label for="contact-field-phone"><xsl:value-of select="php:function('lang', 'Phone')" /></label></dt>
        <dd>
        ...
        <dt><label for="contact-field-email"><xsl:value-of select="php:function('lang', 'Email')" /></label></dt>
        <dd>
        ...
        <dt><label for="contact-field-description"><xsl:value-of select="php:function('lang', 'Description')" /></label></dt>
        <dd class="yui-skin-sam">
            <textarea id="contact-field-description" name="description" type="text"><xsl:value-of select="person/description"/></textarea>
        </dd>
