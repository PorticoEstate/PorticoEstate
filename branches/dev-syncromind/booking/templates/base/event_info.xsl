<xsl:template match="data" xmlns:php="http://php.net/xsl">
    ...
    <div class="pure-form pure-form-aligned">
        <div class="pure-control-group">
            <label><h4><xsl:value-of select="php:function('lang', 'Where')"/></h4></label>
        ...
        <div class="pure-control-group">
            <label><h4><xsl:value-of select="php:function('lang', 'When')"/></h4></label>
            <xsl:value-of select="event/when"/>
        </div>
        <div class="pure-control-group">
            <label><h4><xsl:value-of select="php:function('lang', 'Who')"/></h4></label>
            <xsl:if test="event/is_public=1">
    ...
    <xsl:if test="event/edit_link">
        <div class="actions">
            <button onclick="location.href='{event/edit_link}'" class="pure-button pure-button-primary"><xsl:value-of select="php:function('lang', 'Edit event')"/></button>
        </div>
    </xsl:if>
</xsl:template>
