        ...
        <div id="tab-content">
            ...
            <div id="event_settings" class="booking-container">
                <fieldset>
                    <div class="heading">
                        <legend>
                            <h3><xsl:value-of select="php:function('lang', 'Application event settings')"/></h3>
                        </legend>
                    </div>
                    <div class="pure-control-group">
                        <label for="field_event_change_mail_subject"><xsl:value-of select="php:function('lang', 'Event Change Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_change_mail"><xsl:value-of select="php:function('lang', 'Mail for event change')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_conflict_mail_subject"><xsl:value-of select="php:function('lang', 'Event Conflict Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_mail_conflict_contact_active_collision"><xsl:value-of select="php:function('lang', 'Mail text to conflicting event contact when collision')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_mail_building_subject"><xsl:value-of select="php:function('lang', 'Event message to building Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_mail_building"><xsl:value-of select="php:function('lang', 'Mail text to building contact')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_canceled_mail_subject"><xsl:value-of select="php:function('lang', 'Event Canceled Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_canceled_mail"><xsl:value-of select="php:function('lang', 'Mail for event canceled')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_edited_mail_subject"><xsl:value-of select="php:function('lang', 'Event Edited Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_event_edited_mail"><xsl:value-of select="php:function('lang', 'Mail for event edited')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_booking_canceled_mail_subject"><xsl:value-of select="php:function('lang', 'Booking Canceled Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_booking_canceled_mail"><xsl:value-of select="php:function('lang', 'Mail for booking canceled')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_allocation_canceled_mail_subject"><xsl:value-of select="php:function('lang', 'Allocation Canceled Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_allocation_canceled_mail"><xsl:value-of select="php:function('lang', 'Mail for allocation canceled')"/></label>
