        ...
        <div id="tab-content">
            ...
            <div id="group" class="booking-container"> 
                <fieldset>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Group shortname')" /></label>
                    ...
                    <div class="pure-control-group">
                        <xsl:if test="count(group/contacts/*) &gt; 0">
                            <label style="vertical-align:top;"><xsl:value-of select="php:function('lang', 'Team leaders')" /></label>
