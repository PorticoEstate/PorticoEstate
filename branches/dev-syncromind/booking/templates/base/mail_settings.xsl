        ...
        <div id="tab-content">
            ...
            <div id="mail_settings" class="booking-container">
                <fieldset>
                    <div class="heading">
                        <legend>
                            <h3><xsl:value-of select="php:function('lang', 'Application email settings')"/></h3>
                        </legend>
                    </div>
                    <div class="pure-control-group">
                        <label for="field_application_mail_systemname"><xsl:value-of select="php:function('lang', 'System name')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_subject"><xsl:value-of select="php:function('lang', 'Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_created"><xsl:value-of select="php:function('lang', 'Mail text for application created')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_pending"><xsl:value-of select="php:function('lang', 'Mail text for application pending')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_accepted"><xsl:value-of select="php:function('lang', 'Mail text for application accepted')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_notify_on_accepted"><xsl:value-of select="php:function('lang', 'notify on accepted')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_rejected"><xsl:value-of select="php:function('lang', 'Mail text for application rejected')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_mail_signature"><xsl:value-of select="php:function('lang', 'Signature')"/></label>
                    ...
                    <div class="pure-control-group">
                        <div class="heading">
                            <legend>
                                <h3><xsl:value-of select="php:function('lang', 'Application comment email settings')"/></h3>
                            </legend>
                        </div>
                    </div>
                    <div class="pure-control-group">
                        <label for="field_application_comment_mail_subject_caseofficer"><xsl:value-of select="php:function('lang', 'Subject caseofficer')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_comment_mail_subject"><xsl:value-of select="php:function('lang', 'Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label for="field_application_comment_added_mail"><xsl:value-of select="php:function('lang', 'Mail text for comment added')"/></label>
