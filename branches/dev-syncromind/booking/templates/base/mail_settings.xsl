        ...
        <input type="hidden" name="tab" value=""/>
            <div id="tab-content">
                ...
                <div id="mail_settings">
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Subject')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Mail text for application created')"/></label>
                    ...
                    <div class="pure-control-group">
                            <label><xsl:value-of select="php:function('lang', 'Mail text for application pending')"/></label>
                    ...
                    <div class="pure-control-group">
                            <label><xsl:value-of select="php:function('lang', 'Mail text for application accepted')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'notify on accepted')"/></label>
                    ...
                    <div class="pure-control-group">
                            <label><xsl:value-of select="php:function('lang', 'Mail text for application rejected')"/></label>
                    ...
                    <div class="pure-control-group">
                            <label><xsl:value-of select="php:function('lang', 'Signature')"/></label>
                    ...
                    <div class="pure-control-group">
                            <label><xsl:value-of select="php:function('lang', 'Subject caseofficer')"/></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Mail text for comment added')"/></label>
