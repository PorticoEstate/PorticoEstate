			...
			<div id="tab-content">
				...
				<div id="meta" class="booking-container">
					<div class="pure-control-group">
						<label for="field_metatag_author"><xsl:value-of select="php:function('lang', 'Author')"/></label>
					...
					<div class="pure-control-group">
						<label for="field_metatag_robots"><xsl:value-of select="php:function('lang', 'Robots')"/></label>
					...
					<div class="pure-control-group">
						<label for="field_frontpagetext"><xsl:value-of select="php:function('lang', 'Frontpage text')"/></label>
