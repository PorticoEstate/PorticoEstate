                ...
                <div id="tab-content">
                    ...
                    <div id="report_freetime">
                        <div class="pure-control-group">
                            ...
                            <input class="datetime" id="start_date" name="from" type="text">
                                <xsl:attribute name="value"><xsl:value-of select="from"/></xsl:attribute>
                            </input>
                        </div>
                        <div class="pure-control-group">
                            ...
                            <input class="datetime" id="end_date" name="to" type="text">
                                <xsl:attribute name="value"><xsl:value-of select="to"/></xsl:attribute>
                            </input>
                        </div>
                        <div class="pure-control-group">
                        ...
                        <div class="pure-control-group">
                            ...
                            <ul id="field_weekday" style="display:inline-block;list-style:none;padding:0px;margin:0px;">
                                <li><label><input type="checkbox" value="1" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Monday')" /></label></li>
                                <li><label><input type="checkbox" value="2" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Tuesday')" /></label></li>
                                <li><label><input type="checkbox" value="3" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Wednesday')" /></label></li>
                                <li><label><input type="checkbox" value="4" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Thursday')" /></label></li>
                                <li><label><input type="checkbox" value="5" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Friday')" /></label></li>
                                <li><label><input type="checkbox" value="6" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Saturday')" /></label></li>
                                <li><label><input type="checkbox" value="0" name="weekdays[]" /> <xsl:value-of select="php:function('lang', 'Sunday')" /></label></li>
                            </ul>
                        </div>
                    </div>
                </div>
