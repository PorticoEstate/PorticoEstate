	...
	<form action="" method="POST" id='form' class="pure-form pure-form-aligned" name="form">
            ...
            <div id="tab-content">
                ...
                <div id="system_message" class="booking-container">            
                    ...
                    <div class="pure-control-group">
                        <label style="vertical-align:top;"><xsl:value-of select="php:function('lang', 'Message')" /></label>
                    ...
                    <div class="pure-control-group">
                        <label><xsl:value-of select="php:function('lang', 'Type')" /></label>
            ...
            <div class="form-buttons">
                <xsl:if test="system_message/status = php:function('lang','NEW')"><input class="pure-button pure-button-primary" style="margin-right: 10px;" type="submit" value="{php:function('lang', 'Close')}"/></xsl:if>
