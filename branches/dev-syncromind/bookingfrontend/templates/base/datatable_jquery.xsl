...
<xsl:template match="toolbar" xmlns:php="http://php.net/xsl">
    <style id='toggle-box-css' type='text/css' scoped='scoped'>
        ...
        #toolbar {width: 98%;margin-left: auto;margin-right: auto;background-color: transparent;border: none;}
        #toolbar table {text-align: left;}
        #toolbar table input[type="text"] {margin: auto 0;}
        .toggle-box + label {cursor: pointer;display: block;font-weight: bold;line-height: 21px;margin-bottom: 5px;text-align: left;width: 98%;margin-left: auto;margin-right: auto;}
