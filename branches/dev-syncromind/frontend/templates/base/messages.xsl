						...
						<table>
							...
							<tr>
									...
									<td style="padding-left: 2em;">
										<a href="index.php?menuaction=frontend.uimessages.index&amp;message_id={id}">
							...
							<xsl:choose>
								<xsl:when test="normalize-space(view)">
									<li class="ticket_detail">
										<img src="frontend/templates/base/images/16x16/email_open.png" class="list_image"/>
										<xsl:value-of select="view/subject" disable-output-escaping="yes"/>
									</li>
									<li class="ticket_detail">
										<img src="frontend/templates/base/images/16x16/clock_edit.png" class="list_image"/>
										<xsl:value-of select="view/date" disable-output-escaping="yes"/>
									</li>
									<li class="ticket_detail">
										<img src="frontend/templates/base/images/16x16/user_gray.png" class="list_image"/>
										<xsl:value-of select="view/from" disable-output-escaping="yes"/>
									</li>
									<li class="ticket_detail">
										<img src="frontend/templates/base/images/16x16/page_white_edit.png" class="list_image"/>
										<xsl:value-of select="view/content" disable-output-escaping="yes"/>
									</li>
								</xsl:when>
							</xsl:choose>
						</ul>
