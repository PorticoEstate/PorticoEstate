<?php
/**
 * File for class Bra5StructGetFileAsByteArray
 * @package Bra5
 * @subpackage Structs
 * @date 2015-03-06
 */
/**
 * This class stands for Bra5StructGetFileAsByteArray originally named getFileAsByteArray
 ...
 * @date 2015-03-06
 */
class Bra5StructGetFileAsByteArray extends Bra5WsdlClass
{
    /**
     * The secKey
     * Meta informations extracted from the WSDL
    ...
    public $documentId;
    /**
     * Constructor method for getFileAsByteArray
     * @see parent::__construct()
     * @param string $_secKey
     * @param string $_documentId
     * @return Bra5StructGetFileAsByteArray
     */
