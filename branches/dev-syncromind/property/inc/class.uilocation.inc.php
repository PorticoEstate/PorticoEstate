...
//			$this->type_id 		= $this->bo->type_id;
		...
		function index()
		{
			...
			$data = array(
				...
				'datatable' => array(
					'source' => self::link(array('menuaction' => 'property.uilocation.index', 'phpgw_return_as' => 'json')),
					'download'	=> self::link(array('menuaction' => 'property.uilocation.download', 'export' => true, 'allrows' => true)),
					'allrows'	=> true,
