	...
	public function show_affected_contracts()
	{
		...
		if ($adjustment_id)
		{
			...
			(
				...
				'requestUrl'	=> json_encode(self::link(array('menuaction'=>'rental.uicontract.query', 'editable'=>0, 'type'=>'contracts_for_adjustment', 'id'=>$adjustment_id, 'phpgw_return_as'=>'json'))),
				'ColumnDefs'	=> array(
