	...
	class rental_uifrontpage extends rental_uicommon
	{
		...
		private function _get_tableDef_working()
		{
			$columns_def = array(
				...
				array('key'=>'last_edited_by_current_user', 'label'=>lang('last_edited_by_current_user'), 'sortable'=>false),
				array('key'=>'last_updated', 'label'=>lang('last_updated'), 'sortable'=>true),				
				array('key'=>'term_label', 'label'=>lang('billing_term'), 'sortable'=>true, 'className'=>'center'),
				array('key'=>'total_price', 'label'=>lang('total_price'), 'sortable'=>false, 'className'=>'right', 'formatter'=>'formatterPrice'),
				array('key'=>'rented_area', 'label'=>lang('area'), 'sortable'=>false, 'hidden'=>false, 'className'=>'right', 'formatter'=>'formatterArea'),
				array('key'=>'contract_status', 'label'=>lang('contract_status'), 'sortable'=>false, 'hidden'=>false, 'className'=>'center')
			);
			...
			(
				...
				'requestUrl'	=> json_encode(self::link(array('menuaction'=>'rental.uicontract.query', 'type'=>'last_edited', 'editable'=>false, 'phpgw_return_as'=>'json'))),
		...
		private function _get_tableDef_executive_officer()
		{
			$columns_def = array(
				...
				array('key'=>'date_start', 'label'=>lang('date_start'), 'sortable'=>true, 'className'=>'center'),
		...
		private function _get_tableDef_notifications()
		{
			$columns_def = array(
				...
				array('key'=>'recurrence', 'label'=>lang('recurrence'), 'sortable'=>false, 'className'=>'center'),				
				array('key'=>'name', 'label'=>lang('user_or_group'), 'sortable'=>false),
				array('key'=>'field_of_responsibility', 'label'=>lang('field_of_responsibility'), 'sortable'=>false, 'className'=>'center')
			);
		...
		public function index()
		{
			...
			$tabs['executive_officer']	= array('label' => lang('executive_officer'), 'link' => '#executive_officer', 'function' => 'getData_executive_officer()');
			$tabs['contracts_under_dismissal']	= array('label' => lang('contracts_under_dismissal'), 'link' => '#contracts_under_dismissal', 'function' => 'getData_contracts_under_dismissal()');
			...
			$params_executive_officer = json_encode(array('menuaction'=>'rental.uicontract.query', 'type'=>'contracts_for_executive_officer', 'editable'=>false, 'phpgw_return_as'=>'json'));
			$params_contracts_under_dismissal = json_encode(array('menuaction'=>'rental.uicontract.query', 'type'=>'ending_contracts', 'editable'=>false, 'phpgw_return_as'=>'json'));
			$params_contracts_closing_due_date = json_encode(array('menuaction'=>'rental.uicontract.query', 'type'=>'closing_due_date', 'editable'=>false, 'phpgw_return_as'=>'json'));
			$params_terminated_contracts = json_encode(array('menuaction'=>'rental.uicontract.query', 'type'=>'terminated_contracts', 'editable'=>false, 'phpgw_return_as'=>'json'));
			$params_notifications = json_encode(array('menuaction'=>'rental.uinotification.query', 'type'=>'notifications_for_user', 'editable'=>false, 'phpgw_return_as'=>'json'));
