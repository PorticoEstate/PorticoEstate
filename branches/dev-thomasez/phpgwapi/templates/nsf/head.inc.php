...
JS;
	...
	$stylesheets[] = "/phpgwapi/templates/nsf/css/frontend.css";
	...
	$config->read();
	$logofile_frontend = isset($config->config_data['logopath_frontend']) && $config->config_data['logopath_frontend'] ? $config->config_data['logopath_frontend'] : "/phpgwapi/templates/nsf/images/toppbanner_eventyrene_inspirator.png";
error_log("lff:" . $logofile_frontend);
