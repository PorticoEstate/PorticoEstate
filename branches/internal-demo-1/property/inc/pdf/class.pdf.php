...
class property_pdf_ extends property_pdf__
{
...
*/
function property_pdf_($pageSize=array(0,0,612,792)){
...
function addText($x,$y,$size,$text,$angle=0,$wordSpaceAdjust=0){
  ...
  if (!$this->numFonts){$this->selectFont(PHPGW_APP_INC . '/pdf/fonts/Helvetica');}
