<?php
	...
	class booking_socontact_organization extends booking_socommon
	{
		...
		{
			parent::__construct('bb_organization_contact', 
				array(
					'id'				=> array('type' => 'int'),
					...
					'email' 			=> array('type' => 'string', 'sf_validator' => createObject('booking.sfValidatorEmail', array(), array('invalid' => '%field% contains an invalid email'))),
