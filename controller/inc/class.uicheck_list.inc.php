	...
	class controller_uicheck_list extends phpgwapi_uicommon
	{
      ...
      $user_role = true;
		...
		function view_open_cases()
		{
			...
			self::render_template_xsl( array('check_list/fragments/cases_tab_menu', 'check_list/view_open_cases', 'check_list/case_row', 'check_list/fragments/select_buildings_on_property'), $data );			
		}
