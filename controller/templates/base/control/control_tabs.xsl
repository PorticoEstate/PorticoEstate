  ...
  <div class="yui-navset yui-navset-top" id="control_tabview">
    ...
    <xsl:choose>
      ...
      <xsl:when test="view = 'control_locations'">
        <div class="identifier-header">
          <h1>
            <xsl:value-of select="php:function('lang', 'Control_locations')"/> for 
            <xsl:value-of select="control/title" />
          </h1>
        </div>
        <xsl:value-of disable-output-escaping="yes" select="tabs" />
      ...
      <xsl:when test="view = 'control_component'">
        <div class="identifier-header">
          <h1>
            <xsl:value-of select="php:function('lang', 'Control_component')"/> for 
            <xsl:value-of select="control/title" />
          </h1>
        </div>
        <xsl:value-of disable-output-escaping="yes" select="tabs" />
      ...
      <xsl:when test="view = 'control_items'">
        <div class="identifier-header">
          <h1>
            <xsl:value-of select="php:function('lang', 'Control_items')"/> for 
            <xsl:value-of select="control/title" />
          </h1>
        </div>
        <xsl:value-of disable-output-escaping="yes" select="tabs" />
      ...
      <xsl:when test="view = 'sort_check_list'">
        <div class="identifier-header">
          <h1>
            <xsl:value-of select="php:function('lang', 'Check_list')"/> for 
            <xsl:value-of select="control/title" />
          </h1>
        </div>
        <xsl:value-of disable-output-escaping="yes" select="tabs" />
