...
<xsl:template match="data" xmlns:php="http://php.net/xsl">
	...
	<div id="main_content" class="medium container">
		...
		<div id="view_cases" class="container mt-4">
			<xsl:choose>
				<xsl:when test="component_children/child::node() and count(component_children) &gt; 1">
					...
					<div class="modal-content">
						...
						<div class="modal-header">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-success ml-5 mr-3" data-dismiss="modal">Ferdig</button>
							</div>
						<form action="#">
