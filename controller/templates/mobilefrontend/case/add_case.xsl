											...
											<fieldset>
												...
												<form class="frm_register_case" action="{$action_url}" method="post">
													...
													<xsl:choose>
														<xsl:when test="type = 'control_item_type_1'">
															...
															<label class="form-label mt-2">Beskrivelse av sak</label>
												...
												<div class="add_picture_to_case" style="display:none">
													<form class="add_picture_to_case_form" ENCTYPE="multipart/form-data" method="post">
														...
														<div id="new_picture" class="mb-3">
															<div class="custom-file">
																<label class="form-label custom-file-label" for = "case_picture_file">
																	<xsl:value-of select="php:function('lang', 'new picture')" />
																</label>
																<input type="file" id="case_picture_file" name="file" class="custom-file-input form-control" aria-describedby="submit_update_component">
