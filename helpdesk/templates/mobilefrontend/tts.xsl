...
<xsl:template xmlns:php="http://php.net/xsl" match="add">
	...
	<form class="pure-form pure-form-stacked"  ENCTYPE="multipart/form-data" id="form" name="form" method="post" action="{$form_action}">
		<div id="tab-content">
			...
			<div id="add">
				<fieldset>
					...
					<xsl:choose>
						<xsl:when test="simple !='1'">
							...
							<div class="pure-control-group">
								...
								<input type="text" id="set_on_behalf_of_name" name="values[set_on_behalf_of_name]" value="{value_set_on_behalf_of_name}" class="pure-input-1">
							...
							<div class="pure-control-group">
								...
								<input type="text" id="set_user_alternative_name" name="values[set_user_alternative_name]" class="pure-input-1">
								</input>
							...
							<xsl:if test="disable_priority !='1'">
								<div class="pure-control-group">
									...
									<select name="{$select_priority_name}" title="{$lang_priority_statustext}" class="pure-input-1" >
							...
							<div class="pure-control-group">
								...
								<select id="status_id" name="values[status]" class="pure-input-1" >
									<xsl:attribute name="title">
					...
					<div class="pure-control-group">
						...
						<input type="text" name="values[subject]" value="{value_subject}" size="60"  class="pure-input-1" >
							<xsl:attribute name="title">
			...
			<div id="general">
				<fieldset>
					<div class="pure-control-group">
						...
						<input type="text" name="values[subject]" value="{value_subject}" class="pure-input-1" >
							<xsl:attribute name="title">
