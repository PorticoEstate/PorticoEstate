...
<xsl:template match="list" xmlns:php="http://php.net/xsl">
	<dl>
		<xsl:choose>
	...
	<xsl:variable name="print_action">
		<xsl:value-of select="print_action"/>
	</xsl:variable>
...
<xsl:template match="values">
	<xsl:variable name="lang_qualification_job_text">
		<xsl:value-of select="lang_qualification_job_text"/>
	</xsl:variable>
	<xsl:variable name="lang_task_job_text">
		<xsl:value-of select="lang_task_job_text"/>
	</xsl:variable>
	<xsl:variable name="lang_view_job_text">
		<xsl:value-of select="lang_view_job_text"/>
	</xsl:variable>
	<xsl:variable name="lang_edit_job_text">
		<xsl:value-of select="lang_edit_job_text"/>
	</xsl:variable>
	<xsl:variable name="lang_delete_job_text">
		<xsl:value-of select="lang_delete_job_text"/>
	</xsl:variable>
	<xsl:variable name="lang_add_sub_text">
		<xsl:value-of select="lang_add_sub_text"/>
	</xsl:variable>
	<tr>
		...
		<td style="text-align:center;">
			<xsl:variable name="link_qualification">
				<xsl:value-of select="link_qualification"/>
			</xsl:variable>
			<a href="{$link_qualification}" title="{$lang_qualification_job_text}">
				<xsl:value-of select="text_qualification"/>
			</a>
			<xsl:text> [</xsl:text>
		...
		<td style="text-align:center;">
			<xsl:variable name="link_task">
				<xsl:value-of select="link_task"/>
			</xsl:variable>
			<a href="{$link_task}" title="{$lang_task_job_text}">
				<xsl:value-of select="text_task"/>
			</a>
			<xsl:text> [</xsl:text>
		...
		<td style="text-align:center;">
			<xsl:variable name="link_add_sub">
				<xsl:value-of select="link_add_sub"/>
			</xsl:variable>
			<a href="{$link_add_sub}" title="{$lang_add_sub_text}">
				<xsl:value-of select="text_add_sub"/>
			</a>
		</td>
		<td style="text-align:center;">
			...
			<a href="{$link_view}" title="{$lang_view_job_text}">
		...
		<td style="text-align:center;">
			...
			<a href="{$link_edit}" title="{$lang_edit_job_text}">
		...
		<td style="text-align:center;">
			...
			<a href="{$link_delete}" title="{$lang_delete_job_text}">
...
<xsl:template match="table_add_job">
	<dl>
		...
		<dd height="50">
			<xsl:variable name="reset_action">
				<xsl:value-of select="reset_action"/>
			</xsl:variable>
			<xsl:variable name="lang_reset">
				<xsl:value-of select="lang_reset"/>
			</xsl:variable>
	...
	<form class="pure-form pure-form-aligned" method="post" action="{$form_action}">
		<fieldset>
			...
			<div class="pure-control-group">
				...
				<xsl:variable name="lang_parent_status_text">
					<xsl:value-of select="lang_parent_status_text"/>
				</xsl:variable>
				<select name="values[parent_id]" class="forms" title="{$lang_parent_status_text}">
					<option value="">
						<xsl:value-of select="lang_no_parent"/>
					</option>
...
<xsl:template match="values_task">
	...
	<tr>
			...
			<table align="left">
				<tr>
					...
					<td align="left">
						...
						<a href="{$link_up}" title="$lang_up_text">
						...
						<a href="{$link_down}" title="{$lang_down_text}">
		...
		<td align="center">
			...
			<a href="{$link_view}" title="{$lang_view_text}">
				<xsl:value-of select="text_view"/>
			</a>
		</td>
		<td align="center">
		...
		<form method="post" action="{$form_action}" name = "qualification_form">
			<table cellpadding="2" cellspacing="2" width="80%" align="center">
				...
				<tr>
					...
					<td>
						<xsl:variable name="lang_cat_status_text">
							<xsl:value-of select="lang_cat_status_text"/>
						</xsl:variable>
				...
				<tr>
					...
					<td>
						<xsl:variable name="lang_skill_status_text">
							<xsl:value-of select="lang_skill_status_text"/>
						</xsl:variable>
						<select name="values[skill_id]" class="forms" title="{$lang_skill_status_text}">
							<option value="">
								<xsl:value-of select="lang_no_skill"/>
							</option>
				...
				<tr>
					...
					<td>
						<xsl:variable name="lang_experience_status_text">
							<xsl:value-of select="lang_experience_status_text"/>
						</xsl:variable>
						<select name="values[experience_id]" class="forms" title="{$lang_experience_status_text}">
							<option value="">
								<xsl:value-of select="lang_no_experience"/>
							</option>
