...
<xsl:template match="values">
	<xsl:variable name="lang_view_user_text">
		<xsl:value-of select="lang_view_user_text"/>
	</xsl:variable>
	<xsl:variable name="lang_edit_user_text">
		<xsl:value-of select="lang_edit_user_text"/>
	</xsl:variable>
	<xsl:variable name="lang_training_user_text">
		<xsl:value-of select="lang_training_user_text"/>
	</xsl:variable>
	...
	<tr>
		...
		<td style="text-align:center;">
			...
			<a href="{$link_training}" onMouseover="window.status='{$lang_training_user_text}';return true;" onMouseout="window.status='';return true;">
				<xsl:value-of select="text_training"/>
			</a>
		</td>
		<!--				<td align="center">
	...
	<div align="left">
		...
		<table>
			...
			<table width="100%" cellpadding="2" cellspacing="2" align="center">
				...
				<tr>
					<xsl:variable name="link_cv_action">
						<xsl:value-of select="link_cv"/>
					</xsl:variable>
					<xsl:variable name="text_cv">
						<xsl:value-of select="text_cv"/>
					</xsl:variable>
...
<xsl:template match="table_header_training">
	...
	<xsl:variable name="sort_place">
		<xsl:value-of select="sort_place"/>
	</xsl:variable>
		...
		<form method="post" action="{$form_action}">
			<table cellpadding="2" cellspacing="2" width="80%" align="center">
				...
				<tr>
					...
					<td>
						<xsl:variable name="lang_place_status_text">
							<xsl:value-of select="lang_place_status_text"/>
						</xsl:variable>
						<select name="place_id" onChange ="modplace(this.form)" class="forms" onMouseover="window.status='{$lang_place_status_text}'; return true;" onMouseout="window.status='';return true;">
							<option value="">
								<xsl:value-of select="lang_no_place"/>
							</option>
							<option value="new_place">
								<xsl:value-of select="lang_new_place"/>
							</option>
