<!-- $Id: b_account.xsl,v 1.2 2006/04/12 10:24:43 sigurdne Exp $ -->
	...
	<xsl:template match="values">
		<xsl:variable name="lang_view_b_accounttext"><xsl:value-of select="lang_view_b_accounttext"/></xsl:variable>
		<xsl:variable name="lang_edit_b_accounttext"><xsl:value-of select="lang_edit_b_accounttext"/></xsl:variable>
		<xsl:variable name="lang_delete_b_accounttext"><xsl:value-of select="lang_delete_b_accounttext"/></xsl:variable>
			<tr>
				...
				<td align="center">
					<xsl:choose>
						<xsl:when test="link_edit !=''">
							...
							<a href="{$link_edit}" onMouseover="window.status='{$lang_edit_b_accounttext}';return true;" onMouseout="window.status='';return true;"><xsl:value-of select="text_edit"/></a>
						</xsl:when>
					</xsl:choose>
				</td>
				<td align="center">
					<xsl:choose>
						<xsl:when test="link_delete !=''">
							...
							<a href="{$link_delete}" onMouseover="window.status='{$lang_delete_b_accounttext}';return true;" onMouseout="window.status='';return true;"><xsl:value-of select="text_delete"/></a>
						</xsl:when>
					</xsl:choose>
				</td>
			</tr>
