<?php
	...
	* @version $Id: class.soap_server.inc.php,v 1.15 2006/12/28 18:03:40 Caeies Exp $
	*/
...
class phpgwapi_soap_server extends phpgwapi_nusoap_base {
	...
	function phpgwapi_soap_server($wsdl=false){
		...
		if($wsdl){
			...
			if (is_object($wsdl) && (get_class($wsdl) == 'wsdl')) {
				...
				$this->wsdl = createObject ("phpgwapi.wsdl",$wsdl);
	...
	*/
    function parseRequest($headers, $data) {
		...
		$parser = createObject ("phpgwapi.soap_parser",$data,$this->xml_encoding,'',$this->decode_utf8);
		// parser debug
	...
	*/
	function fault($faultcode,$faultstring,$faultactor='',$faultdetail=''){
		...
		$this->fault = createObject ("phpgwapi.soap_fault",$faultcode,$faultactor,$faultstring,$faultdetail);
    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='rpc', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
        ...
        $this->wsdl->schemas[$schemaTargetNamespace][0] = createObject ("phpgwapi.soap_XMLSchema",'', '', $this->wsdl->namespaces);
