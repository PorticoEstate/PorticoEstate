<?php
	...
	* @version $Id: class.soapclient.inc.php,v 1.13 2006/12/28 18:03:40 Caeies Exp $
	*/
...
class phpgwapi_soapclient extends phpgwapi_nusoap_base  {
	...
	* @access   public
	*/
	function phpgwapi_soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		...
		if($wsdl){
			if (is_object($endpoint) && (get_class($endpoint) == 'wsdl')) {
				...
				$this->wsdl = createObject ("phpgwapi.wsdl",$this->wsdlFile,$this->proxyhost,$this->proxyport,$this->proxyusername,$this->proxypassword,$this->timeout,$this->response_timeout);
			}
		...
		switch(true){
			...
			case ereg('^http',$this->endpoint):
				...
				if($this->persistentConnection == true && is_object($this->persistentConnection)){
					...
					$http = createObject ("phpgwapi.soap_transport_http",$this->endpoint);
	...
	*/
    function parseResponse($headers, $data) {
		...
		$parser = createObject ("phpgwapi.soap_parser",$data,$this->xml_encoding,$this->operation,$this->decode_utf8);
