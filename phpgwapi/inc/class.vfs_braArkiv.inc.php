<?php
	...
	* @package phpgwapi
	* @subpackage vfs
	* @version $Id: class.vfs_sql.inc.php 11334 2013-09-26 18:13:25Z sigurdne $
	*/
...
throw new Exception('implement WRITE to braArkiv');
...
throw new Exception('implement touch to braArkiv');
		...
		function mv ($data)
		{
			...
			)
			{
				...
				*/
				...
				if ($this->file_actions)
				{
throw new Exception('implement RENAME to braArkiv');
		...
		function rm ($data)
		{
			...
			)
			{
				if ($this->file_actions)
				{
throw new Exception('implement DELETE from braArkiv');
