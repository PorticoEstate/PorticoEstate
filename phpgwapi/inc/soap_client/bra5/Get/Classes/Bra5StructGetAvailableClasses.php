<?php
/**
 * File for class Bra5StructGetAvailableClasses
 * @package Bra5
 * @subpackage Structs
 * @date 2015-03-06
 */
/**
 * This class stands for Bra5StructGetAvailableClasses originally named GetAvailableClasses
 ...
 * @date 2015-03-06
 */
class Bra5StructGetAvailableClasses extends Bra5WsdlClass
{
    /**
     * The secKey
     * Meta informations extracted from the WSDL
    ...
    public $secKey;
    /**
     * Constructor method for GetAvailableClasses
     * @see parent::__construct()
     * @param string $_secKey
     * @return Bra5StructGetAvailableClasses
     */
