<?php
/**
 * File for class Bra5StructGetFileName
 * @package Bra5
 * @subpackage Structs
 * @date 2015-03-06
 */
/**
 * This class stands for Bra5StructGetFileName originally named getFileName
 ...
 * @date 2015-03-06
 */
class Bra5StructGetFileName extends Bra5WsdlClass
{
    /**
     * The secKey
     * Meta informations extracted from the WSDL
    ...
    public $documentId;
    /**
     * Constructor method for getFileName
     * @see parent::__construct()
     * @param string $_secKey
     * @param string $_documentId
     * @return Bra5StructGetFileName
     */
