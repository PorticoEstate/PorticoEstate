<?php
/**
 * File for class Bra5StructGetRelativeFileURL
 * @package Bra5
 * @subpackage Structs
 * @date 2015-03-06
 */
/**
 * This class stands for Bra5StructGetRelativeFileURL originally named getRelativeFileURL
 ...
 * @date 2015-03-06
 */
class Bra5StructGetRelativeFileURL extends Bra5WsdlClass
{
    /**
     * The secKey
     * Meta informations extracted from the WSDL
    ...
    public $documentId;
    /**
     * Constructor method for getRelativeFileURL
     * @see parent::__construct()
     * @param string $_secKey
     * @param string $_documentId
     * @return Bra5StructGetRelativeFileURL
     */
