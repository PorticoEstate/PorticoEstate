...
<div class="footer">
    ...
    <div class="footer-left">
        ...
        <img src="http://aktivby.alesund.kommune.no/phpgwapi/templates/bkbooking/images/newlayout/headerlogo_alesund.png" alt="Nye Ålesund"/>
            
    </div>
    
    <div class="footer-center">
        <p>  
            <a href="http://www.alesund.kommune.no/">Ålesund kommune</a><br>
            Postboks 1521, 6025 Ålesund<br>
            Tlf: 70 16 20 00<br>
            <a href="mailto:postmottak@alesund.kommune.no" target="_top">postmottak@alesund.kommune.no</a>
        </p>
