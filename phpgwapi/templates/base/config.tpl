...
<!-- BEGIN body -->
   ...
   <tr bgcolor="{row_on}">
    ...
    <td><input name="newsettings[site_username]" value="{value_site_username}" autocomplete="off"
			   readonly="readonly" onfocus="this.removeAttribute('readonly');"/></td>
   </tr>

   <tr bgcolor="{row_off}">
    <td>{lang_Enter_the_site_password_for_peer_servers}.</td>
    <td><input type="password" name="newsettings[site_password]" value="{value_site_password}" autocomplete="off"
			   readonly="readonly" onfocus="this.removeAttribute('readonly');"/></td>
   </tr>
