        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3 d-flex flex-column mb-4">
                ...
                <ul class="text-small list-unstyled mb-0">
                    <li><a target="_blank" rel="noopener noreferrer" href="{footer_logo_url}">{municipality}</a></li>
            ...
            <div class="col-12 col-sm-6 col-md-3 d-flex flex-column mb-4">
                ...
                <ul class="text-small list-unstyled mb-0">
                    <li><a target="_blank" rel="noopener noreferrer" href="https://www.aktiv-kommune.no/">{textaboutmunicipality}</a></li>
            ...
            <div class="col-12 col-sm-6 col-md-3 d-flex flex-column mb-4">
                ...
                <ul class="text-small list-unstyled mb-0">
					...
					{org_info_view}
                    <li><i class="fas fa-sign-in-alt me-1"></i><a target="_blank" rel="noopener noreferrer" href="{executiveofficer_url}">{executiveofficer}</a></li>
                </ul>
            </div>
        </div>
    </div>
