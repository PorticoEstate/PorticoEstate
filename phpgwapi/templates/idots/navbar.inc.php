<?php
	...
	*/
	function parse_navbar($force = False)
	{
		...
		$var['logo_title'] = isset($GLOBALS['phpgw_info']['server']['login_logo_title']) && $GLOBALS['phpgw_info']['server']['login_logo_title'] ? $GLOBALS['phpgw_info']['server']['login_logo_title'] : 'phpGroupWare --&gt; home';
...
//_debug_array($GLOBALS['phpgw_info']['navbar']);
			...
			if ($app != 'home' && $app != 'preferences' && $app != 'about' && $app != 'logout')
			{
				$item = array
					(
						...
						'target'	=> isset($app_data['target'])?$app_data['target']:''
					);
		...
		$file[] = array ('text' => 'Manual', 'url' => $GLOBALS['phpgw']->link('/index.php', array('menuaction' => 'manual.uimanual.index','app' => $GLOBALS['phpgw_info']['flags']['currentapp'])));
