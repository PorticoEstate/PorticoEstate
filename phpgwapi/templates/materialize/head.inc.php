<?php
	...
	$javascripts[] = "/phpgwapi/js/materialize/js/materialize.min.js";
	...
	if( !$GLOBALS['phpgw_info']['flags']['noframework'] && !$GLOBALS['phpgw_info']['flags']['nonavbar'] )
	{
		...
		{
			$javascripts[] = "/phpgwapi/templates/materialize/js/jqtree_jsmenu.js";
			$javascripts[] = "/phpgwapi/templates/materialize/js/sidenav.js";
		}

	}
	$javascripts[] = "/phpgwapi/templates/materialize/js/init.js";
	...
	$stylesheets[] = "/phpgwapi/templates/materialize/css/base.css";


    if(isset($GLOBALS['phpgw_info']['user']['preferences']['common']['theme']))
	{
		$stylesheets[] = "/phpgwapi/templates/materialize/css/{$GLOBALS['phpgw_info']['user']['preferences']['common']['theme']}.css";
	}

	$stylesheets[] = "/{$app}/templates/materialize/css/base.css";
	if(isset($GLOBALS['phpgw_info']['user']['preferences']['common']['theme']))
	{
		$stylesheets[] = "/{$app}/templates/materialize/css/{$GLOBALS['phpgw_info']['user']['preferences']['common']['theme']}.css";
	}
