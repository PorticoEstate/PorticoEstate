...
<xsl:template match="table_head">
	<tr class="th">
		<th>
			<xsl:value-of select="lang_ext_user"/>
		</th>
		<th>
			<xsl:value-of select="lang_location"/>
		</th>
		<th>
			<xsl:value-of select="lang_auth_type"/>
		</th>
		<th>
			<xsl:value-of select="lang_allow_deny"/>
		</th>
		<th>
...
<xsl:template name="table_row">
	<tr>
		...
		<td>
			<xsl:value-of select="ext_user"/>
		</td>
		<td>
			<xsl:value-of select="location"/>
		</td>
		<td>
			<xsl:value-of select="auth_type"/>
		</td>
		<td>
			<a>
				<xsl:attribute name="href">
					<xsl:value-of select="allow_deny_url"/>
				</xsl:attribute>
