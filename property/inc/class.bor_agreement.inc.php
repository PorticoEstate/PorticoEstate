<?php
	...
	* @subpackage agreement
 	* @version $Id: class.bor_agreement.inc.php 18358 2007-11-27 04:43:37Z skwashd $
	*/
...
//html_print_r($list);
			...
			$GLOBALS['phpgw']->session->appsession('insert_record_r_agreement' . !!$detail,'property',$insert_record_list);
