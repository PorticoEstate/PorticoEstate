<?php
	...
	//				$joins .= " {$this->left_join} fm_tts_quick_order_template_msg ON fm_tts_quick_order_template_msg.excom_id = fm_tts_quick_order_template.id";
	//				$cols = ",fm_tts_quick_order_template_msg.message";
					if($query)
					{
		...
		function get_messages( $id, $sort = 'ASC' )
		{
			...
			{
				case 'property':
					$table	 = 'fm_tts_quick_order_template_msg';
					break;
				case 'helpdesk':
