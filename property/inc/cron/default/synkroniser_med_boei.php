...
SQL;
			...
			while ($this->db_boei->next_record())
			{
				$valueset[] = array
					...
					4 => array
						(
						'value' => ($this->db_boei->f('Beskrivelse')),
						'type' => PDO::PARAM_STR
					)
				);
			}
...
SQL;
			...
			while ($this->db_boei->next_record())
			{
				$valueset[] = array
					...
					2 => array
						(
						'value' => ($this->db_boei->f('Fornavn')),
						'type' => PDO::PARAM_STR
					),
					3 => array
						(
						'value' => ($this->db_boei->f('Etternavn')),
						'type' => PDO::PARAM_STR
					),
					4 => array
						(
