...
#
	...
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO fm_location2 ( location_code , loc1 , loc2 , loc2_name , entry_date , category, street_id, street_number, status, user_id , remark )VALUES ('5000-01', '5000', '01', 'Location name', NULL , '1', 1, '1A', '1', '6', 'remark')");
...
#
	...
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO fm_location_config (location_type, column_name, input_text, lookup_form, f_key, ref_to_category, query_value, reference_table, reference_id, datatype, precision_, scale, default_value, nullable) VALUES (2, 'street_id', NULL, 1, 1, NULL, 1, 'fm_streetaddress', 'id', 'int', 4, NULL, NULL, 'True')");
...
#
	...
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO phpgw_cust_attribute (location_id, id, column_name, input_text, statustext, datatype, list, attrib_sort, size, precision_, scale, default_value, nullable,custom) VALUES ($location_id, 22, 'zip_code', 'Zip code', 'Zip code', 'V', NULL, 10, NULL, 4, NULL, NULL, 'True', 1)");
...
// Admin get full access
	...
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO fm_ecodimb_role (id, name, amount_limit) VALUES (1, 'Bestiller', 50000)", __LINE__, __FILE__);
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO fm_ecodimb_role (id, name, amount_limit) VALUES (2, 'Attestant', 250000)", __LINE__, __FILE__);
	$GLOBALS['phpgw_setup']->oProc->query("INSERT INTO fm_ecodimb_role (id, name, amount_limit) VALUES (3, 'Anviser', 1000000)", __LINE__, __FILE__);
