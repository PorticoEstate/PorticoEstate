						...
						<tr><td align="right" valign="bottom">
								<form method="post" name="alarm" action="{$edit_url}">
									...
									<table cellpadding="2" cellspacing="2" width="79%" align="center" border="0">
										...
										<!-- DataTable 0  EDIT-->
										<tr><td class="center" align="left" colspan="10"><div id="datatable-container_0"/></td></tr>
										<tr><td class="center" align="right" colspan="10"><div id="datatable-buttons_0"/></td></tr>
										...
										<tr><td class="center" align="left" colspan="10"><div id="datatable-buttons_1"/></td></tr>
