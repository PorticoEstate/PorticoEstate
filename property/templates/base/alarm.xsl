...
<xsl:template match="table_header">
	...
	<tr class="th">
		<td width="10%" align="right">
			<a href="{$sort_alarm_id}" class="th_text"><xsl:value-of select="lang_alarm_id"/></a>
		</td>
		<td width="10%">
			<a href="{$sort_next_run}" class="th_text"><xsl:value-of select="lang_next_run"/></a>
		</td>
		<td width="10%" align="center">
			<xsl:value-of select="lang_times"/>
		</td>
		<td width="10%">
			<a href="{$sort_method}" class="th_text"><xsl:value-of select="lang_method"/></a>
		</td>
		...
		<td width="10%">
			<a href="{$sort_user}" class="th_text"><xsl:value-of select="lang_user"/></a>
		</td>
		<td width="5%" align="center">
...
<xsl:template match="alter_alarm">
	<tr height="20">
		<td align="right" valign="bottom" colspan="9">
			<xsl:variable name="lang_test_cron"><xsl:value-of select="lang_test_cron"/></xsl:variable>
			...
			<form name="form" method="post" action="{$edit_url}">
				<table cellpadding="2" cellspacing="2" width="79%" align="center">
					...
					<tr>
						...
						<td align="left">
							<xsl:variable name="lang_method_statustext"><xsl:value-of select="lang_method_statustext"/></xsl:variable>
							<select name="values[method_id]" class="forms" onMouseover="window.status='{$lang_method_statustext}'; return true;" onMouseout="window.status='';return true;">
								<option value=""><xsl:value-of select="lang_no_method"/></option>
