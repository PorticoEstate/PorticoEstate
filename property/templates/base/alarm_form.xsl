	...
	<xsl:template match="add_alarm">
		<tr height="20">
			<td valign="top" align="right" colspan="5">
				...
				<xsl:variable name="lang_day_statustext"><xsl:value-of select="lang_day_statustext"/></xsl:variable>
				...
				<xsl:variable name="lang_hour_statustext"><xsl:value-of select="lang_hour_statustext"/></xsl:variable>
				...
				<xsl:variable name="lang_minute_statustext"><xsl:value-of select="lang_minute_statustext"/></xsl:variable>
