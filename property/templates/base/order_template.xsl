							...
							<xsl:otherwise>
								<div class="pure-control-group">
									...
									<div class="pure-control-group">
										...
										<input type="hidden" id="external_project_id" name="external_project_id"  value="{value_external_project_id}"/>
								...
								<xsl:attribute name="title">
									...
									<!--<xsl:if test="enable_order_service_id = 1">-->
										<div class="pure-control-group">
											...
											<input type="hidden" id="service_id" name="service_id"  value="{value_service_id}"/>
									...
									<xsl:if test="enable_unspsc = 1">
										<div class="pure-control-group">
											...
											<input type="hidden" id="unspsc_code" name="unspsc_code"  value="{value_unspsc_code}"/>
											<input class="pure-input-3-4" type="text" id="unspsc_code_name" name="unspsc_code_name" value="{value_unspsc_code} {value_unspsc_code_name}">
												<xsl:attribute name="data-validation">
													<xsl:text>required</xsl:text>
												</xsl:attribute>
												<xsl:attribute name="data-validation-error-msg">
