<!-- $Id$ -->
	...
	<xsl:template name="select_district">
		<xsl:variable name="lang_district_statustext"><xsl:value-of select="lang_district_statustext"></xsl:value-of></xsl:variable>
		<xsl:variable name="select_district_name"><xsl:value-of select="select_district_name"></xsl:value-of></xsl:variable>
		<select name="{$select_district_name}" class="forms" onMouseover="window.status='{$lang_district_statustext}'; return true;" onMouseout="window.status='';return true;">
			<option value=""><xsl:value-of select="lang_no_district"></xsl:value-of></option>
			<xsl:apply-templates select="district_list"></xsl:apply-templates>
		</select>
	</xsl:template>
