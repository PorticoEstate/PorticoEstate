...
* @package etemplate
* @version $Id: class.date_widget.inc.php,v 1.18 2007/02/13 19:52:04 sigurdne Exp $
*/
	/**
	...
	class date_widget
	{
		...
		function pre_process($name,&$value,&$cell,&$readonlys,&$extension_data,&$tmpl)
		{
			...
			if ((isset($cell['readonly']) && $cell['readonly']) || $readonlys)	// is readonly
			{
				$sep = array(
					1 => $sep[1],
					2 => $sep[1],
				...
				{
					$str .= ($str != '' ? (isset($sep[$n]) ? $sep[$n] : '') : '');
					$str .= isset($value[$format[$n]]) ? $value[$format[$n]] : '';
				}
				$value = $str;
				$cell['type'] = 'label';
				$cell['no_lang'] = True;
