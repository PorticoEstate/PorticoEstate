...
* @package etemplate
* @version $Id: class.link_widget.inc.php,v 1.11 2007/02/13 12:59:32 sigurdne Exp $
*/

	/**
	* link-to:   Widget to create links to an other entries of link-aware apps
	*
	* link-list: Widget to shows the links to an entry and a Unlink Button for each link
	*
	* link-string: comma-separated list of link-titles with a link to its view method, value is like get_links()
	*
	* This widget is independent of the UI as it only uses etemplate-widgets and has therefor no
	* 	 * render-function.
	*/
	class link_widget
	{
