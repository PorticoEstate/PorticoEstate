<!-- $Id: addressbook.tpl,v 1.11 2001/05/30 16:04:06 bettina Exp $ -->
...
<script LANGUAGE="JavaScript">
	...
	{
		opener.document.order_form.abid.value = thisform.elements[0].value;
		opener.document.order_form.name.value = thisform.elements[1].value;
	}
</script>
</head>
