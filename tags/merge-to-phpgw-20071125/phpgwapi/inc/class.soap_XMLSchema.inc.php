<?php
	...
	* @version $Id: class.soap_XMLSchema.inc.php,v 1.2 2006/12/28 18:03:40 Caeies Exp $
	*/
...
class phpgwapi_soap_XMLSchema extends phpgwapi_nusoap_base  {
	...
	* @access   public
	*/
	function phpgwapi_soap_XMLSchema($schema='',$xml='',$namespaces=array()){
		parent::phpgwapi_nusoap_base();
		$this->debug('soap_XMLSchema class instantiated, inside constructor');
		// files
		$this->schema = $schema;
		$this->xml = $xml;
