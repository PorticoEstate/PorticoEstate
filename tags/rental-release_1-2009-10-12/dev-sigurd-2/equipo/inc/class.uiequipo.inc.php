  ...
  class equipo_uiequipo
  {
    ...
    (
      ...
      'gab' => true
		...
		{
			return 'function success_handler(o) {
	...
	function ActionToPHP(task,argu)
				{
					...
					{
						if(argu[cont].value != "" )postData += "&"+argu[cont].variable + "=" + argu[cont].value ;
					}
					...
					ActionToPHP("find",[{variable:\'payments\',value:arraySearch[0].checked},
							{variable:\'address\',value:arraySearch[1].value},
							{variable:\'prodid\',value:arraySearch[2].value},
							{variable:\'gaardsnr\',value:arraySearch[3].value},
							{variable:\'bruksnr\',value:arraySearch[4].value},
							{variable:\'festenr\',value:arraySearch[5].value},
							{variable:\'seksjonsnr\',value:arraySearch[6].value}]);
					}';
		}
    	...
    	$datatable = array();
    	$datatable['config']['base_url'] = $GLOBALS['phpgw']->link('/index.php', array('menuaction'	=> 'equipo.uiequipo.gab'));
		...
		$datatable['actions']['form'] = array(
			...
			//CREACION DE FILTROS
			array(
				'sourceJS' => equipo_uiequipo::GetSourceJS(),
				'fields'	=> array(
					'field' => array(
						array(
							'id'	=> 'someid',
		...
		phpgwapi_yui::load_widget('dragdrop');
	  	...
	  	//$GLOBALS['phpgw']->js->validate_file( '../phpgwapi/js/yahoo/menu', 'menu-min', $this->currentapp );

		//$GLOBALS['phpgw']->js->add_external_file('phpgwapi/js/yahoo/menu/menu-min.js');
