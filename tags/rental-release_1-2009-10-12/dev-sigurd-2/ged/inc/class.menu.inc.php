		...
		function get_menu()
		{
			...
			*/
			...
			(
				'ged' => array
				(
					'text'	=> $GLOBALS['phpgw']->translation->translate('ged', array(), true),
					'url'	=> $GLOBALS['phpgw']->link('/index.php', array('menuaction'=> 'ged.ged_ui.browse') ),
			...
			if ( isset($GLOBALS['phpgw_info']['user']['apps']['admin']) )
			{
				...
				*/
				...
				(
					...
					'url'	=> $GLOBALS['phpgw']->link('/index.php', array('menuaction' => 'ged.ged_admin.types', 'appname' => 'ged')),
				...
				(
					...
					'url'	=> $GLOBALS['phpgw']->link('/index.php', array('menuaction' => 'ged.ged_admin.places', 'appname' => 'ged')),
					'image'	=> array('ged', 'admin')
				);
			}
			...
			if ( isset($GLOBALS['phpgw_info']['user']['apps']['preferences']) )
			{
				...
				*/
				...
				(
					...
					'url'	=> $GLOBALS['phpgw']->link('/preferences/preferences.php', array('appname'	=> 'ged')),
			...
			*/
			$menus['folders'] = phpgwapi_menu::get_categories('ged');
