...
YAHOO.activitycalendar.autocompleteHelper = function(url, field, hidden, container) {
...
YAHOO.activitycalendar.inlineTableHelper = function(container, url, colDefs, options) {
	options = options || {};
	var myDataSource = new YAHOO.util.DataSource(url);
	myDataSource.responseType = YAHOO.util.DataSource.TYPE_JSON;
	myDataSource.connXhrMode = "queueRequests";
...
YAHOO.activitycalendar.radioTableHelper = function(container, url, name, selection) {
	return YAHOO.activitycalendar.checkboxTableHelper(container, url, name, selection, 'radio')
}

YAHOO.activitycalendar.checkboxTableHelper = function(container, url, name, selection, type) {
	type = type || 'checkbox';
	selection = selection || [];
	var myDataSource = new YAHOO.util.DataSource(url);
	myDataSource.responseType = YAHOO.util.DataSource.TYPE_JSON;
...
YAHOO.activitycalendar.setupDatePickers = function() {
	YAHOO.util.Dom.getElementsByClassName('date-picker', null, null, YAHOO.activitycalendar.setupDatePickerHelper, [true, false]);
	YAHOO.util.Dom.getElementsByClassName('time-picker', null, null, YAHOO.activitycalendar.setupDatePickerHelper, [false, true]);
	YAHOO.util.Dom.getElementsByClassName('datetime-picker', null, null, YAHOO.activitycalendar.setupDatePickerHelper, [true, true]);
}
