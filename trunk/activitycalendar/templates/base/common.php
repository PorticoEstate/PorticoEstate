...
/**
 * Javascript for the activitycalendar module.  Holds datasource init functions and form helpers.
 *
 * Functions and objects within this file are kept in the YAHOO.activitycalendar namespace.
 */
	...
	YAHOO.activitycalendar.formatDate = function(elCell, oRecord, oColumn, oData) {
		//alert("oDate: " + oData);
...
?>
			...
			<?php
				$populate = phpgw::get_var('populate_form');
				if(isset($populate)){?>
					var qs = YAHOO.activitycalendar.serializeForm(source_properties.form);
			...
			var storeColumnsUrl = YAHOO.activitycalendar.storeColumnsUrl;
	...
	function formListener(event){
		...
		var qs = YAHOO.activitycalendar.serializeForm(this.properties.form);
