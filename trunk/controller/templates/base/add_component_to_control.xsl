...
<xsl:template match="datatable" xmlns:php="http://php.net/xsl">
  ...
  <form action="#" name="component_form" id="component_form" method="post">
    <div class="component_submit">
      <input type="submit" name="save_component" id="save_component" value="{$label_submit}" onclick="return savecomponentToControl()"/>
    </div>
  </form>
</xsl:template>
