      ...
      <li>
        ...
        <select id="type_id" name="type_id">
          <xsl:for-each select="building_types">
            <xsl:variable name="building_type_id">
              <xsl:value-of select="id"/>
            </xsl:variable>
      ...
      <li>
        <select id="cat_id" name="cat_id">
          <xsl:for-each select="category_types">
            <xsl:variable name="category_type_id">
              <xsl:value-of select="id"/>
            </xsl:variable>
...
<xsl:template match="datatable" xmlns:php="http://php.net/xsl">
  ...
  <xsl:variable name="label_checkAll">
    <xsl:value-of select="php:function('lang', 'invert_checkboxes')" />
  </xsl:variable>
  <div>
    <input type="button" id="select_all" value="{$label_checkAll}" onclick="checkAll('mychecks')"/>
  </div>
  <form action="#" name="location_form" id="location_form" method="post">
    <div class="location_submit">
      <input type="submit" name="save_location" id="save_location" value="{$label_submit}" onclick="return saveLocationToControl()"/>
    </div>
  </form>
</xsl:template>
