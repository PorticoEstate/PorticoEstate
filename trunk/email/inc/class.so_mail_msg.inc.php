<?php
	...
	* @package email
	* @version $Id: class.so_mail_msg.inc.php,v 1.10 2006/12/17 11:21:02 sigurdne Exp $
	...
	class so_mail_msg
	{
		...
		*/
		function so_set_data($data_key, $content, $compression=False)
		{
			...
			$account_id = get_account_id(0, $GLOBALS['phpgw']->session->account_id);
		...
		*/
		function so_get_data($data_key, $compression=False)
		{
			...
			|| ($this->so_have_data_group() == False))
			{
				...
				$account_id = get_account_id('', $GLOBALS['phpgw']->session->account_id);
				$data_key = $GLOBALS['phpgw']->db->db_addslashes($data_key);
