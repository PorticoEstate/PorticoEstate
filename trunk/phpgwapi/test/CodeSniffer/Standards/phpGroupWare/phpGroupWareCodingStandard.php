...
class PHP_CodeSniffer_Standards_phpGroupWare_phpGroupWareCodingStandard extends PHP_CodeSniffer_Standards_CodingStandard
{
	...
	public function getIncludedSniffs()
	{
		...
		//		'Squiz/Sniffs/Commenting/', we need something similar to this that meets our requirements
				...
				'Squiz/Sniffs/PHP/DisallowCountInLoopsSniff.php',				// performance
				'Squiz/Sniffs/PHP/DisallowMultipleAssignmentsSniff.php',		// readability
				'Squiz/Sniffs/PHP/EvalSniff.php',								// security 
				'Squiz/Sniffs/PHP/InnerFunctionsSniff.php',						// maintainability
				'Squiz/Sniffs/PHP/NonExecutableCodeSniff.php'					// sanity check
			   );
