	...
	class preferences_menu
	{
		...
		function get_menu()
		{
			...
			(
				'preferences' => array
				(
					'text'	=> $GLOBALS['phpgw']->translation->translate('Preferences', array(), 'preferences'),
			...
			$menus['navigation'][] = array
			(
				'text'	=> $GLOBALS['phpgw']->translation->translate('My Preferences', array(), 'preferences'),
			...
			if ($GLOBALS['phpgw']->acl->check('changepassword',1))
			{
				$menus['navigation'][] = array
				(
					'text'	=> $GLOBALS['phpgw']->translation->translate('Change your Password', array(), 'preferences'),
				...
				|| (isset($GLOBALS['phpgw_info']['server']['half_remote_user']) && $GLOBALS['phpgw_info']['server']['half_remote_user'] == 'remoteuser') )
			{
				if($GLOBALS['phpgw_info']['server']['mapping'] == 'table' || $GLOBALS['phpgw_info']['server']['mapping'] == 'all')
				{
					$menus['navigation'][] = array
					(
						'text'	=> $GLOBALS['phpgw']->translation->translate('Mapping', array(), 'preferences'),
			...
			if ( isset($navbar['admin']) )
			{
				$menus['navigation'][] = array
				(
					'text'	=> $GLOBALS['phpgw']->translation->translate('Default Preferences', array(), 'preferences'),
					'url'	=> $GLOBALS['phpgw']->link('/preferences/index.php', array('type' => 'default') )
				);
				$menus['navigation'][] = array
				(
					'text'	=> $GLOBALS['phpgw']->translation->translate('Forced Preferences', array(), 'preferences'),
