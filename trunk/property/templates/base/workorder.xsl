...
<!-- add / edit -->
	...
	<xsl:template match="edit" xmlns:php="http://php.net/xsl">
		...
		<table cellpadding="2" cellspacing="2" align="center">
			...
			<xsl:choose>
				<xsl:when test="value_workorder_id!='' and location_template_type='form'">
					<td>
						<table>
							<tr>
								<td valign="top" >
				...
				<div class="yui-content">
					...
					<div id="general">
						<table cellpadding="2" cellspacing="2" width="80%" align="center">
							...
							<xsl:choose>
								<xsl:when test="need_approval='1' and location_template_type='form'">
									<tr>
										<td valign="top">
	...
	<xsl:choose>
		...
		<table>
			<tr>
				...
				<xsl:choose>
					<xsl:when test="location_template_type='view'">
						<td>
