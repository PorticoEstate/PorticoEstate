<?php
	/**************************************************************************\
	* phpGroupWare Workflow - Mail SMTP Agent Connector - interface layer        *
	* ------------------------------------------------------------------------ *
	...
	* any later version.                                                       *
	...
	/* $Id: class.ui_agent_mail_smtp.inc.php 19830 2005-11-14 19:37:58Z regis_glc $ */
	...
	require_once(dirname(__FILE__) . '/' . 'class.ui_agent.inc.php');
