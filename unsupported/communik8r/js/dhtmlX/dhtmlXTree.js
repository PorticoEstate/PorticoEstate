...
function dhtmlXTreeObject(htmlObject, width, height, rootId)
{
	...
	this.imPath = 'treeGfx/';
	//this.imPath = oApplication.strBaseURL + 'templates/default/images/';
	...
	//this.imageArray = new Array('nosub-16x16.png', 'folder-16x16.png', 'folder-16x16.png');
...
dhtmlXTreeObject.prototype._attachChildNode = function(parentObject, itemId, itemText, itemActionHandler, image1, image2, image3, optionStr, childs, beforeNode)
{
	...
	if ( parentObject.XMLload == 0 && this.XMLsource && !his.XMLloadingWarning )
	{
	...
	try{
		if (sNode)
			if ((this._getLineStatus(itemObject.id,sNode)==0)||(!this.treeLinesOn))
			{
				...
				for(var i=1; i<=itemObject.childsCount; i++)
				{
					itemObject.htmlNode.childNodes[0].childNodes[i].childNodes[0].style.backgroundImage = 'url(' + this.imPath + 'nosub-16x16.png)';
...
dhtmlXTreeObject.prototype._HideShow=function(itemObject,mode)
{
	...
	{
		itemObject.XMLload=1; this.loadXML(this.XMLsource+getUrlSymbol(this.XMLsource)+"id="+escape(itemObject.id));
		return;
	}
...
dhtmlXTreeObject.prototype.onRowSelect=function(e,htmlObject,mode)
{
	...
	{
		htmlObject.parentObject.treeNod.lastSelected.childNodes[0].className = 'standardTreeRow';
		if (htmlObject.parentObject.treeNod.lastSelected.parentObject.acolor)
		{
			htmlObject.parentObject.treeNod.lastSelected.parentObject.span.style.color
				= htmlObject.parentObject.treeNod.lastSelected.parentObject.acolor;
		}
	}
...
dhtmlXTreeObject.prototype._createItem = function(acheck, itemObject, mode)
{
	 ...
	 */
	var td1=document.createElement('td');
	td1.className = 'standardTreeImage';
	var img0 = document.createElement('img');
	img0.border = '0'; 
	//img0.src='treeGfx/line1.gif';
	...
	/*
	   td11.className='standardTreeImage';
	   if (acheck)
	 */
	...
	td12.className = 'standardTreeImage';
	...
	itemObject.span.className = 'standardTreeRow';
...
{
	if ( (shtmlObject && shtmlObject.parentObject.id == htmlObject.id)
			|| (htmlObject.id == itemId) )
	{
		return 1;
	}
...
dhtmlXTreeObject.prototype._clearStyles=function(itemObject)
{
	...
	td3.childNodes[0].className = 'standardTreeRow';
...
dhtmlXTreeObject.prototype._registerBranch=function(itemObject,oldTree)
{
	/*
	   for (var i=0; i<itemObject.childsCount; i++)
	   {
	   if (confirm(itemObject.childNodes[i].id))
	   {
	   return;
	   }
	   }
...
dhtmlXTreeObject.prototype._deleteItem=function(itemId,selectParent,skip)
{
	...
	if (!skip)
	{
		...
		/*
		   if (sNode.parentObject.id)
		   {
		   sNode.parentObject.onRowSelect(0,sNode.parentObject.htmlNode.childNodes[0].childNodes[0].childNodes[3]);
		   }
		 */
	}
...
dhtmlXTreeObject.prototype._clearMove = function(htmlNode)
{
	...
	{
		htmlNode.parentObject.span.className = 'standardTreeRow';
...
dhtmlXTreeObject.prototype._dragIn = function(htmlObject,shtmlObject)
{
	...
	if ( !this._checkParenNodes(shtmlObject.parentObject.id, htmlObject.parentObject, shtmlObject.parentObject) 
